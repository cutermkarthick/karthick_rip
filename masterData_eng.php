...
$_SESSION['pagename'] = 'master_datadetails4engapp';
...
<td><span class="pageheading"><b>Master data</b><td colspan=250></td>
    ...
    <?php
       if($myrow["status"] !='Inactive' && $dept !='ENGAPP')
       {
    ?>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
<tr bgcolor="#FFFFFF">
<td width=8% bgcolor="#EEEFEE"><span class="heading"><b><center>Line number</center></b></td>
<td width=15% bgcolor="#EEEFEE"><span class="heading"><b><center>Mps Rev</center></b></td>
<td width=12% bgcolor="#EEEFEE"><span class="heading"><b><center>Rev Status</center></b></td>
<td width=10% bgcolor="#EEEFEE"><span class="heading"><b><center>Rev Date</center></b></td>
<td width=15% bgcolor="#EEEFEE"><span class="heading"><b><center>Control(Machine Name)</center></b></td>
<td width=40% bgcolor="#EEEFEE"><span class="heading"><b><center>Remarks</center></b></td>
</tr>
<?php
...
<?php
  ...
  ?>
        ...
        ?>
          <tr bgcolor="#FFFFFF">
            <td><span class="labeltext">Engineering Approved</td>
            <td bgcolor="#FFFFFF"><input type="checkbox" <?php echo $myrow_rm["eng_app"] == 'yes'?$checked:"" ?>  id="engineering_approved" name="engineering_approved" disabled onClick="return readOnlyCheckBox()">
                         <input type="hidden" name="eng_app_rm" value="<?php echo $myrow_rm["eng_app"]?>" id="eng_app_rm">
                         <input type="hidden" name="masterdatarecnum_rm" id="masterdatarecnum_rm" value="<?php echo $masterdatarecnum?>"></td></td>
            <td><span class="labeltext">Engineering Approved By</td>
            <td><span class="tabletext"><?php echo $myrow_rm["eng_app_by"] ?></td>
          </tr>
