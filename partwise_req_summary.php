...
$_SESSION['pagename'] = 'partwise_req_summary';
//////session_register('pagename');

// First include the class definition
include_once('classes/userClass.php');
include_once('classes/partwise_reqclass.php');
...
<form action='partwise_req_summary.php' method='post' enctype='multipart/form-data'>
<?php
...
<table width=100% border=0>
  <tr>
  <td><span class="pageheading"><b>List Of Partwise Requirements</b></td>
  <td colspan=160>&nbsp;</td>
  <td><a href ="partwise_req.php"><img name="Image8" border="0" src="images/new_part_req.gif"></a>
  </td>
  </tr>
</table>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        <tr bgcolor="#FFCC00">
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Achieved</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Balance</b></td>
        </tr>


<?php

            $result = $newPR->getallpartwise_reqs();

            while ($myrow = mysql_fetch_row($result)) {


   	       printf('<tr bgcolor="#FFFFFF"><td ><span class="tabletext">
                          <a href="partwise_reqdetails.php?partwise_reqrecnum=%s">%s</td>
