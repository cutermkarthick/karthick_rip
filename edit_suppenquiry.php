...
$_SESSION['pagename'] = 'editsuppenquiry';
...
$result = $newsuppenquiry->getenquiry($recnum);
...
<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=6 class="stdtable1">
        ...
        <tr bgcolor="#DDDEDD">
         ...
         <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="vendor" size=30 style="background-color:#DDDDDD" readonly="readonly" value="<?php echo $myrow['name']?>"><img src="images/bu-get.gif" alt="Get Customer" onclick="GetAllVendors()">
            <input type="hidden" name="vendrecnum" id="vendrecnum" value="<?php echo $myrow['link2cust']?>">
            </td>
        ...
        <tr bgcolor="#FFFFFF">
           <td><span class="labeltext"><p align="left"><span class='asterisk'>*</span>Part Number</p></font></td>
            <td><span class="tabletext"><input type="text" name="partnum" size=30 style="background-color:#DDDDDD" readonly="readonly" value="<?php echo $myrow['partnum']?>"><img src="images/bu-get.gif" alt="Get Customer" onclick="getallpartnum4supplier()"></td>
