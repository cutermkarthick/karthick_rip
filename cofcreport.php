...
// Filename: cofcreport.php                    =
// Copyright of Fluent Technologies            =
// Revision: v1.0 WMS                          =
// Displays Cofc synopsis                      =
//==============================================
...
if ( isset ( $_REQUEST['type']) )
{
     ...
     else if ($val == 'With Treatment')
     {
         $cond4 = "d.type = 'With Treatment'";
     }
...
<form action='cofcreport.php' method='post' enctype='multipart/form-data'>
<?php
...
<tr>
<td colspan=8 align="center" bgcolor="#00DDFF"><span class="heading"><b>Cofc Summary</b></td>
</tr>
...
<?php
      ...
      {
?>
	<option selected="With Treatment">With Treatment
	<option value="Assembly">Assembly
...
?>
	...
	<option value="With Treatment">With Treatment
	<option value="Manufacture Only">Manufacture Only</option>
	 <option value="Kit">Kit</option>
 	 <option value="All">All</option>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        <tr  bgcolor="#FFCC00">
            <td width="4%" bgcolor="#EEEFEE"><span class="tabletext"><b>Rel Note#</b></td>
            <td width="5%" bgcolor="#EEEFEE"><span class="tabletext"><b>Type</b></td>
            <td width="4%" bgcolor="#EEEFEE"><span class="tabletext"><b>Status</b></td>
            <td width="4%" bgcolor="#EEEFEE"><span class="tabletext"><b>Dispatch Date</b></td>
            <td width="11%" bgcolor="#EEEFEE"><span class="tabletext"><b>Customer</b></td>
			<td width="5%" bgcolor="#EEEFEE"><span class="tabletext"><b>PRN</b></td>
			<td width="5%" bgcolor="#EEEFEE"><span class="tabletext"><b>Part #</b></td>
            <td width="4%" bgcolor="#EEEFEE"><span class="tabletext"><b>WO#</b></td>
            <td width="4%" bgcolor="#EEEFEE"><span class="tabletext"><b>Dispatch Qty</b></td>
     ...
     $result = $newdispatch->getdispatch($cond,$offset,$sort1,$rowsPerPage);
            ...
            while ($myrow = mysql_fetch_row($result)) {
              if($myrow[2] != '' && $myrow[2] != '0000-00-00')
               ...
               {
                  echo "<td bgcolor=\"#00FF00\"><span class=\"tabletext\">$myrow[6]</td>";
               }
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"cofcreport.php?page=$page&totpages=$totpages&final_relno=$finalrel_match&
    ...
    $first = " <a href=\"cofcreport.php?page=1&totpages=$totpages&final_relno=$finalrel_match&final_wo=$final_womatch&
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"cofcreport.php?page=$page&totpages=$totpages&final_relno=$finalrel_match&final_wo=$final_womatch&
	final_crn=$final_crnmatch&ddate1=$ddate1_match&ddate2=$ddate2_match&type=$val&final_partnum=$final_partnummatch\">[Next]</a> ";

    $last = " <a href=\"cofcreport.php?page=$totpages&totpages=$totpages&final_relno=$finalrel_match&final_wo=$final_womatch&final_crn=$final_crnmatch&ddate1=$ddate1_match&ddate2=$ddate2_match&type=$val&final_partnum=$final_partnummatch\">[Last Page]</a> ";
}
else
{
