...
$_SESSION['pagename'] = 'process_details_summary';
//////session_register('pagename');

// First include the class definition
include_once('classes/userClass.php');
include_once('classes/process_detailsclass.php');
...
<form action='process_details_summary.php' method='post' enctype='multipart/form-data'>
<?php
...
<table width=100% border=0>
  <tr>
  <td><span class="pageheading"><b>List Of Process Details</b></td>
  <td colspan=160>&nbsp;</td>
  <td><a href ="process_details.php"><img name="Image8" border="0" src="images/bu_proc_det.gif"></a>
  </td>
  </tr>
</table>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        <tr bgcolor="#FFCC00">
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Part Tasks</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Mfg. Cycle Time</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Inspection Time</b></td>
        </tr>


<?php

            $result = $newPD->getallprocess_details();

            while ($myrow = mysql_fetch_row($result)) {


   	       printf('<tr bgcolor="#FFFFFF"><td ><span class="tabletext">
                          <a href="proc_det_details.php?process_detailsrecnum=%s">%s</td>
