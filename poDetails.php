...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1" >
	<tr bgcolor="#FFFFFF">
		<?php
			...
			$date=date("M j, Y",$x);
		?>
		<td width=25%><span class="labeltext"><p align="left">PO Date</p></font></td>
		<td width=25%><span class="tabletext"><?php echo $date ?></td>
		<td width=25%><span class="labeltext"><p align="left">PO Date</p></font></td>
		<td width=25%><span class="tabletext"><?php echo $date ?></td>
	</tr>
	<?php
	...
	$checked="checked";
	?>
		<td width=25%><span class="labeltext"><p align="left">Approval</p></font></td>
		<td width=25%><span class="tabletext"><input type="checkbox" <?php echo $myrow["approval"] == 'yes'?$checked:"" ?> onClick="return readOnlyCheckBox()"/></td>
		<td width=25%><span class="labeltext"><p align="left">Approval Date</p></font></td>
	<?php
	...
	<tr bgcolor="#FFFFFF">
		<td width=25%><span class="labeltext"><p align="left">Amendment No.</p></span></td>
		<td width=25%><span class="tabletext"><?php echo $myrow["amendment_num"] ?></span></td>
		<td width=25%><span class="labeltext"><p align="left">Amendment Date</p></span></td>
	<?php
	...
	?>
		<td width=25%><span class="tabletext"><?php echo $date2 ?></span></td>
	...
	<tr bgcolor="#FFFFFF">
		<td width=25%><span class="labeltext"><p align="left">Amendment Notes</p></font></td>
	...
	<tr bgcolor="#FFFFFF">
		<td width=25%><span class="labeltext"><p align="left">Header</p></font></td>
...
<td colspan=9></td>
 ...
 -->
<tr bgcolor='#FFFFFF'>
<td bgcolor="#FFFFFF"  align="right" colspan=29><span class="tabletext"><b>Total</b></td>
<td align="right" bgcolor="#FFFFFF" colspan=2><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["poamount"]); ?></td>
<td colspan=3 bgcolor="#FFFFFF">&nbsp;</td>
</tr>

<tr bgcolor='#FFFFFF'>
<td bgcolor="#FFFFFF" align="right" colspan=29><span class="tabletext"><b>Tax</b></td>
...
<tr>
<td bgcolor="#FFFFFF" colspan=29 align="right"><span class="tabletext"><b>Shipping</b></td>
<td align="right" bgcolor="#FFFFFF" colspan=2><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["shipping"]); ?></td>
<td colspan=3 bgcolor="#FFFFFF">&nbsp;</td>
</tr>
<tr>
<td bgcolor="#FFFFFF" colspan=29 align="right"><span class="tabletext"><b>Labor</b></td>
<td align="right" bgcolor="#FFFFFF" colspan=2><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["labor"]); ?></td>
<td colspan=3 bgcolor="#FFFFFF">&nbsp;</td>
</tr>
<tr>
<td bgcolor="#FFFFFF" colspan=29 align="right"><span class="tabletext"><b>Total Due</b></td>
...
<<<<<<< HEAD
<table style="width:138%" border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
<tr bgcolor="#DFDFDF">
<td  width=20% colspan=4><span class="pageheading"><b>MODIFICATION DETAILS</b></td>
=======

<table id="myTable" style="width:128% !important;" border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
<tr bgcolor="#DFDFDF">
<td  width=25% colspan=4 ><span class="pageheading"><b>MODIFICATION DETAILS</b></td>
>>>>>>> e00e26c32b0f0fdc8db02ba88cf2459b82440971
</tr>
<?php

if($myrow['creation_date'] != '0000-00-00' && $myrow['creation_date'] != '' && $myrow['creation_date'] != 'NULL')
{
$datearr = split('-', $myrow['creation_date']);
$d=$datearr[2];
$m=$datearr[1];
$y=$datearr[0];
$x=mktime(0,0,0,$m,$d,$y);
...
if($myrow['last_modified'] != '0000-00-00' && $myrow['last_modified'] != '' && $myrow['last_modified'] != 'NULL')
{
$datearr = split('-', $myrow['last_modified']);
$d=$datearr[2];
$m=$datearr[1];
$y=$datearr[0];
$x=mktime(0,0,0,$m,$d,$y);
...
<tr bgcolor='#FFFFFF'>
<td bgcolor="#FFFFFF"  width=25%><span class="labeltext">Create Date</td>
<td width=25%><span class="tabletext"><?php echo $cr_date; ?></td>
<td bgcolor="#FFFFFF"  width=25%><span class="labeltext">Created By</td>
<td width=25%><span class="tabletext"><?php echo $myrow['created_by'] ?></td>
</tr>
<tr bgcolor='#FFFFFF'>
<td bgcolor="#FFFFFF"  width=25%><span class="labeltext">Modified Date</td>
<td width=25%><span class="tabletext"><?php echo $md_date?></td>

<td bgcolor="#FFFFFF"  width=25%><span class="labeltext">Modified By</td>
<td width=25%><span class="tabletext"><?php echo $myrow['modified_by'] ?></td>
</tr>
</table>

<<<<<<< HEAD

<table border = 1 cellpadding=0 cellspacing=0 style="width:138%" class="stdtable1">
<tr><td align="center"><span class="tabletext"><b>
...
<table border=3 bgcolor="#DFDEDF" style="width:138%" cellspacing=1 cellpadding=3 class="stdtable1">
<tr bgcolor="#FFFFFF">
...
=======
<table border=0 cellpadding=3 cellspacing=1 style="width:128% !important;" class="stdtable1" bgcolor="#DFDEDF">

	<tr>
		<td align="center" ><span class="tabletext"><b>
			If Material is ordered in Meters, the same
			can be supplied in random lengths but each
			length not exceeding 3 meters
			</b>
	...
	<tr bgcolor="#FFFFFF">
		<td width="50%"><span class="labeltext"><?php printf('%s',$myrow["formatnum"]); ?></td>
		<td width="50%"><span class="labeltext"><?php printf('%s',$myrow["formatrev"]); ?></td>
	</tr>
>>>>>>> e00e26c32b0f0fdc8db02ba88cf2459b82440971
</table>
