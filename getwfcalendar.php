...
if (ctype == 'NewDate') 
  {
    window.opener.SetwfDate(document.f.eventdate.value,document.f.index.value);
    self.close();
   }
if (ctype == 'EditDate') 
  {
    window.opener.SetwfDate4Edit(document.f.eventdate.value,document.f.index.value);
    self.close();
   }
}
</script>
...
<table><tr><td valign="top">
	...
	<form name="f" action="getwfcalendar.php" method="POST">
<?php
...
<tr><td colspan=7 bgcolor="#CCCCDD">
    ...
    <tr><th width="20"><a href="getcalendar.php?m=<?=(($m-1)<1) ? 12 : $m-1 ?>&y=<?=(($m-1)<1) ? $y-1 : $y ?>">&lt;&lt;</a></th>
