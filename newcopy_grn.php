...
//==============================================
// Author: FSI                                 =
// Date-written = Dec 09, 2013                 =
// Filename: newcopy_grn.php                   =
// Copyright (C) FluentSoft Inc.               =
// Contact bmandyam@fluentsoft.com             =
// Revision: v1.0 WMS                          =
// Allows entry of Copy GRN                    =
//==============================================
session_start();
...
<tr>
<td><span class="pageheading"><b>COPY GRN</b></td>
</tr>
...
<td><span class="labeltext"><p align="left">Balance Qty</p></font></td>
<td><input type="text" id="remain_qty" name="remain_qty" size=20 value="<?=$remain_qty?>" style=";background-color:#DDDDDD;" readonly="readonly">
</td>
...
<td width=25%><span class=\"tabletext\"><input type="text" id="mlayout_ref"  name="mlayout_ref" value="" size="20" onkeyup="javascript:swap_removereadonly(this)"></td>
</tr>-->
...
<td bgcolor="#EEEFEE"><span class="heading"><b><center>Billets<br>Req</center></b></td>
<td bgcolor="#EEEFEE"><span class="heading"><b><center>New<br/>Qty</center></b></td>
<td bgcolor="#EEEFEE"><span class="heading"><b><center>New<br/>Qty/Billet</center></b></td>
...
while($i<2)
{
	if($grnrecnum != '')
	{
	    while ($mygrnli = mysql_fetch_row($grnli))
        {
			...
			$d3=$mygrnli[4];
			$um=$mygrnli[14];
			$qtyto_make=$mygrnli[9];
			$rec_li=$mygrnli[7];
	        $amendlinenum=$mygrnli[17];
			$layoutref = $mygrnli[18];
		if ($amendlinenum != '')
		{
          echo "<td><center><span class=\"tabletext\"><input type=\"text\" id=\"$line_num\"  name=\"$line_num\" value=\"\" 
		  style=\"background-color:#DDDDDD\" readonly=\"readonly\" size=\"2%\"><center></td>";
		}
		else
		{
          echo "<td><center><span class=\"tabletext\"><input type=\"text\" id=\"$line_num\"  name=\"$line_num\" value=\"$i\" size=\"2%\"><center></td>";
		}		
		echo "<td><center><span class=\"tabletext\"><input type=\"text\" id=\"$amend_line_num\"  name=\"$amend_line_num\" value=\"$amendlinenum\" style=\"background-color:#DDDDDD\" readonly=\"readonly\" size=\"2%\"><center></td>";
		echo "<td><center><span class=\"tabletext\"><input type=\"text\" id=\"$layout_ref\"  name=\"$layout_ref\" value=\"$layoutref\" size=\"12%\"
		onchange=\"javascript:swap_removereadonly($i)\"><center></td>";

		echo "<td><center><input type=\"text\" id=\"$partnum\" name=\"$partnum\" size=\"6%\" value=\"\"><center></td>";
		echo "<td><center><input type=\"text\" id=\"$partdesc\" name=\"$partdesc\" size=\"15%\" value=\"\"><center></td>";
		...
		echo "<td><center><input type=\"text\" id=\"$qty_parent\" name=\"$qty_parent\" size=\"3%\" value=\"$qty_value\" style=\"background-color:#DDDDDD\" readonly=\"readonly\"><center></td>";
        echo "<td><center><input type=\"text\" id=\"$qty4billet_parent\" name=\"$qty4billet_parent\"  size=\"5%\" value=\"$myrow_rm[0]\"   style=\"background-color:#DDDDDD\" readonly=\"readonly\"><center></td>";
		echo "<td><center><input type=\"text\" id=\"$billetsreq\" name=\"$billetsreq\" size=\"6%\" value=\"\"><center></td>";
		echo "<td><center><input type=\"text\" id=\"$qty\" name=\"$qty\" size=\"3%\" value=\"$qty_value\" onkeyup=\"javascript:getqtm_value($i);\"><center></td>";
		
		echo "<td><center><input type=\"text\" id=\"$qty4billet\" name=\"$qty4billet\"  size=\"5%\" value=\"$myrow_rm1[0]\" 
                       onkeyup=\"javascript:getqtm_value($i);\" ><center></td>";
		echo "<td><center><input type=\"text\" id=\"$qty_rej\" name=\"$qty_rej\"  size=\"5%\" value=\"\"><center></td>";
		echo "<td><center><input type=\"text\" id=\"$qty_to_make\" name=\"$qty_to_make\" size=\"5%\" value=\"$qtyto_make\" onblur=\"javascript:get_total(this);\" style=\"background-color:#DDDDDD\"  ><center></td>";
		printf('</tr>');
		echo "<td><center><span class=\"tabletext\"><input type=\"hidden\" id=\"$recnum_li\"  name=\"$recnum_li\" value=\"$rec_li\" size=\"2%\"><center></td>";
	...
	{		
       ...
       echo "<td><center><span class=\"tabletext\"><input type=\"text\" id=\"$layout_ref\"  name=\"$layout_ref\" value=\"$layoutref\" size=\"12%\"
		onchange=\"javascript:swap_removereadonly($i)\"><center></td>";       echo "<td><center><input type=\"text\" id=\"$partnum\" name=\"$partnum\" size=\"6%\" value=\"\"><center></td>";
       ...
       echo "<td><center><input type=\"text\" id=\"$qty_parent\" name=\"$qty_parent\" size=\"3%\" value=\"\"><center></td>";
	  	 echo "<td><center><input type=\"text\" id=\"$qty4billet_parent\" name=\"$qty4billet_parent\"  size=\"5%\" value=\"\"><center></td>";
...
<td align=right><input type=text name=total_qty_make id=total_qty_make size=5% value='<?=$total?>' style=";background-color:#DDDDDD;" readonly="readonly"></td>
</tr>
</table>
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
<tr bgcolor="#DDDEDD">
...
<input type="hidden" name="pagename" id="pagename" value="newcopy_grn">
...
<input type="hidden" name="num_rows_f" id="num_rows_f" value='<?=$num_rows_from?>'>
...
<input type="hidden" name="num_rows_t" id="num_rows_t" value='<?=$num_rows_to?>'>
