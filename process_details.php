...
$_SESSION['pagename'] = 'new_process_details';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="part_tasks" size=40 value=""></td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Mfg. Cycle Time</p></font></td>
            <td><input type="text" name="mfg_cycle_time" size=20 value=""></td>
            <td><span class="labeltext"><p align="left">Inspection Time</p></font></td>
            <td><input type="text" name="inspection_time" size=20 value=""></td>
