...
$_SESSION['pagename'] = 'assypoSummary';
...
<form action='assypoSummary.php' method='get' enctype='multipart/form-data'>
<?php
...
<table width=100% border=0>
  ...
  <td colspan=200>&nbsp;</td>
  <td align='right'><a href ="assypoNew.php"><img name="Image8" border="0" src="images/new.gif"></a>
  </td>
  </tr>
</table>
...
<?php				
              ...
              if($prev_ponum != $myrow[1])
              {
               ...
               echo "<a href=\"assypoDetails.php?delrecnum=$myrow[0]\">$myrow[1]</td>";
