...
/* if (isset($_REQUEST['submit'])) 
{
		 ...
		 header ("Location: new_ucompany.php");
}*/
									...
									<table width=100% border=0 cellpadding=4 cellspacing=1 bgcolor="#DFDEDF" >
										...
										<tr><td>
											...
											<tr>
												...
												<td colspan=150>&nbsp;</td>
											         	<td><a href ="new_ucompany.php"><img name="Image8" border="0" src="images/bu-newcompany.gif"></a>
												</td>
    											</tr>
										      </table>
										</td></tr>
										...
										<td>
											<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
													...
													$result = $newCompany->getCompanies($cond,$sort1,$offset,$rowsPerPage);
	     												 ...
	     												 printf('<tr><td bgcolor="#FFFFFF"><span class="tabletext"><a href="edit_ucompany.php?companyid=%s"><b>%s</b></td>
