...
$_SESSION['pagename'] = 'qa4efficiency';
//////session_register('pagename');

// First include the class definition
include_once('classes/qa4efficiencyClass.php');
...
<html>
<head>
<title>QA Efficiency Summary</title>
</head>
...
<form action='qa4efficiency.php' method='post' enctype='multipart/form-data'>
<?php
...
<table width=100% border=0>
  ...
  <td>
  <a href ="qa4efficiencyEntry.php"><img name="Image8" border="0" src="images/new.gif"></a>
  </td>
  </tr>
...
<?php
         ...
         $result = $newQA->getqasummary($cond,$sort1,$offset,$rowsPerPage);
         $total_dispatched = 0;
         $total_accepted = 0;
         ...
         if($myrow[3] != '' && $myrow[3] != '0000-00-00')
          ...
          $accp_rating = round($accp_rating1);
   	       printf('<tr bgcolor="#FFFFFF"><td ><span class="tabletext">
                           <a href="qa4efficiencyDetails.php?qa4effrecnum=%s">%s</td>
...
$numrows = $newQA->getqacount($cond,$offset,$rowsPerPage);
