...
$_SESSION['pagename'] = 'editcustinvoice';
...
<tr bgcolor="#FFFFFF" >
          ...
          <td width=20% ><input type="text" name="company" id="company" style=";background-color:#DDDDDD;"
 ...
 <?php
		 ...
		 <tr bgcolor="#FFFFFF">
            ...
            <td width=20%><span class="tabletext"><p align="left"><input type="text" name="countryoffinaldest" size=30 style=";background-color:#DDDDDD;"
...
<?php
	 ...
	 echo "<td align=\"center\"><input type=\"text\" name=\"$crn\" id=\"$crn\" size=\"10\"  style=\"background-color:#DDDDDD;\"
		  		readonly=\"readonly\" value=\"$li[3]\"><img src=\"images/bu-get.gif\" width=\"85px\" height=\"20px\" alt=\"Get CRN\"  onclick=\"GetCRN4invoice($i)\"></td>";
     ...
     echo "<td align=\"center\"><input type=\"text\" name=\"$cofc\" id=\"$cofc\"size=\"5\" value=\"$li[2]\" style=\"background-color:#DDDDDD;\"
 	 ...
 	 echo "<td align=\"center\"><input type=\"text\" name=\"$ponum\" id=\"$ponum\" size=\"10\" style=\"background-color:#DDDDDD;\"
		  		readonly=\"readonly\" value=\"$li[1]\"><img src=\"images/bu-getpo.gif\" alt=\"Get CustPo\" onclick=\"GetCustpo($i)\">
	...
	/*echo " <input type=\"text\" name=\"pagename\" id=\"pagename\" style=\"background-color:#DDDDDD;\"
		  		readonly=\"readonly\" size=\"15\" value=\"custinvedit\">";*/
?>
</table>
...
<Table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
      ...
      <tr bgcolor="#FFFFFF">
            <td colspan=2 style="width:90%"><span class="labeltext"><p align="right">Total</p></font></td>
            			  <td align="right"><span class="tabletext"><input type="text" name="inv_totamt" size=5 id ="inv_totamt" style="background-color:#DDDDDD;"
...
?>
     ...
     <!--  <tr bgcolor="#FFFFFF">
        ...
        <td colspan=2><span class="labeltext"><p align="right">Service Tax</p></font></td>
            <td align="right" colspan = 2><input type="text" name="service_tax" id="service_tax" size=3 value="<?php echo $myrow["service_tax"] ?>" onkeyup="javascript:Calculate_total()"></td>   
            </tr> -->
<tr bgcolor="#FFFFFF">
