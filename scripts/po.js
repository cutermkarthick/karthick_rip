    ...
    acc_flag=0; var stat_flag=0;  var stat_closeflag=0;   var close_flag=0;
     while (x <= 30)
     {
       ...
       if (document.getElementById(ln).value.length != 0)
       {
          ...
          && document.getElementById("potype").value != "Consummables")
           {
...
if(document.getElementById("vendrecnum").value=="")
{
...
function SetCrn(CIM,fieldname,flag,potype) 
{
  // alert(CIM+"-----------"+potype);
   ...
   if(potype!='Bought Out' && potype!='Consummables')
   {
   ...
   var no_unites_req=CIM[3].toUpperCase();  
      if(no_unites_req == 'MM')
		  num_req_units='Mts';
	  else if(no_unites_req == 'INCHES')
		   num_req_units='Ft';
	   else
		   num_req_units='';
	  

	var id16="num_of_units_req"+ fieldname;
   var text6= document.getElementById(id16);
   text6.value=num_req_units;
