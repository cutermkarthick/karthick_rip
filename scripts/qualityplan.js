...
function check_req_fields()
{
	...
	//return false;
    var errmsg = '';
    if (document.forms[0].opnrefno.value.length == 0)
    {
    //alert ('function working inside');
         errmsg += 'Please enter opnrefnum \n';
    }

    if (document.forms[0].operationnumber.value.length == 0)
    {
         errmsg += 'Please enter Operation number\n';
    }
    if (document.forms[0].partnumber.value.length == 0)
    {
         errmsg += 'Please enter partnum\n';
    }

    if (document.forms[0].revnumber.value.length == 0)
    {
         errmsg += 'Please enter revnum\n';
    }
...
function printqualityplan(qualityplanrecnum) {
var winWidth = 680;
var winHeight = 800;
var winLeft = (screen.width-winWidth)/2;
var winTop = (screen.height-winHeight)/2;
win1 = window.open("printqualityplan.php?qualityplanrecnum=" + qualityplanrecnum, "PrintQualityplan",
