...
function printproc_details(process_detailsrecnum) {
var winWidth = 680;
var winHeight = 800;
var winLeft = (screen.width-winWidth)/2;
var winTop = (screen.height-winHeight)/2;
win1 = window.open("printproc_details.php?process_detailsrecnum=" + process_detailsrecnum, "printprocess_details",
