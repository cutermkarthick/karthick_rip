...
inp8.setAttribute("name",est_time);
...
function printdatasheet(dsrecnum) {
var winWidth = 680;
var winHeight = 800;
var winLeft = (screen.width-winWidth)/2;
var winTop = (screen.height-winHeight)/2;
win1 = window.open("printdatasheet.php?dsrecnum=" + dsrecnum, "printdatasheet",
