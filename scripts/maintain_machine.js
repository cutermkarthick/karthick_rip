...
function printmaintain_machine(maintain_machinerecnum) {
var winWidth = 680;
var winHeight = 800;
var winLeft = (screen.width-winWidth)/2;
var winTop = (screen.height-winHeight)/2;
win1 = window.open("printmaintain_machine.php?maintain_machinerecnum=" + maintain_machinerecnum, "printmaintain_machinerecnum",
