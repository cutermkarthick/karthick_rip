...
// Filename: getvendors4spmaster.php            =
// Copyright (C) FluentSoft Inc.               =
// Contact bmandyam@fluentsoft.com             =
// Revision: v1.0 OWT                          =
// Popup for selecting customer address        =
//==============================================
            ...
            <td><span class="tabletext"><select name="customer" size="1">
             ...
             <?php
                 while ($myrow = mysql_fetch_row($result)) {
                       $arg="'" . $myrow[2] . "|" . $myrow[3] . "|" . $myrow[4] . "|" . $myrow[5] . "|" . $myrow[6] . "|" . $myrow[7] . "|" . $myrow[8] . "|" . $myrow[9] . "|" . $myrow[10] . "|" . $myrow[11] . "|" . $myrow[12] . "|" . $myrow[13] . "|" . $myrow[0] . "'";
