...
<form action='consumptionReport.php' method='post' enctype='multipart/form-data'>
<?php
...
// status, closingbal, invoice_date, cofc_num, bond_num, be_num, grnwonum, company, rmtype, uom
	...
	{
?>
      <td width="80px" bgcolor="#FFCC00"><span class="tabletext"><a href="bondEdit.php?bondnum=<?php echo $myrow['bond_num'] ?>">	<?php echo $myrow['bond_num'] ?></a></td>
...
<?php
	...
	{
?>
      <td width="100px" bgcolor="00FF00"><span class="tabletext"><a href="beEdit.php?benum=<?php echo $myrow['be_num'] ?>">	<?php echo $myrow['be_num'] ?></a></td>
...
?>
					    ...
					    <a href="consumptionEdit.php?recnum=<?php echo $myrow['recnum'] ?>"><?php echo $myrow['invoice_num'] ?></a></td>
