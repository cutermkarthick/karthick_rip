...
<table width=80% border=0 cellpadding=3 cellspacing=1>
          <tr>
          <td colspan=5>
           <table width=50% style="border:1px solid;cellspacing:2px;" cellpadding=0 class="stdtable1"><tr bordercolor="black">
		  ...
		  <td colspan=5>
           <table width=50% style="border:1px solid;cellspacing:1px;" cellpadding=0 cellspacing=1><tr bordercolor="black">
          ...
          <td colspan=3>
          <table width=50% style="border:1px solid" cellpadding=0 cellspacing=1 bordercolor="black">
            <tr><td style=";background-color:#DDDDDD;"><span class="tabletext"><font color="0000ff"><b>Bench  Time</b></font></td>
             <td width=100px style=";background-color:#FFFFFF;"><span class="tabletext"><input type="text" name="fitting_time_hrs" maxlength=2  style="width:50%;Border:none" size=8 value=""><b>:</b>
			                            <input type="text" name="fitting_time_mins" maxlength=2 style="width:50%;Border:none" size=8 value="">
       ...
       <td colspan=3>
            ...
            <td width=120px style=";background-color:#FFFFFF;"><span class="tabletext"><input type="text" name="insp_time_hrs" maxlength=2 style="width:50%;Border:none" size=8 value=""><b>:</b>
			                            <input type="text" name="insp_time_mins" maxlength=2 style="width:50%;Border:none" size=8 value="">
         ...
         <tr>
         <td colspan=1>
            <table width=25% style="border:1px solid;cellspacing:1px;" cellpadding=0 cellspacing=1 bordercolor="black">
            <tr><td style=";background-color:#DDDDDD;"><span class="tabletext"><font color="0000ff"><b>From Date</b></font>
            <input type="text" name="fromdate" size=12 value="" style=";background-color:#DDDDDD;" readonly="readonly"><img src="images/bu-getdateicon.gif" alt="Get Date" onclick="GetDate('fromdate')"></td>
              <td style=";background-color:#DDDDDD;"><span class="tabletext"><font color="0000ff"><b>To Date</b></font>
                <input type="text" name="todate" size=12 value="" style=";background-color:#DDDDDD;" readonly="readonly"><img src="images/bu-getdateicon.gif" alt="Get Date" onclick="GetDate('todate')"></td>
        ...
        <table width=80% style="border:1px solid" cellpadding=3 cellspacing=1 rows=all columns=all class="stdtable">
