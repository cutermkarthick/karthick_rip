...
?>
 ...
 //email address of cutsomer- to address added 0n 12/10/2006
      ...
      $toaddr= $my[0];
      $fromaddr= "suresh@fluentsoft.com";
...
<tr>
<td ><span class="pageheading"><b>Quote Details</b><td colspan=150></td>
...
<input type= "image" name="Delete" src="images/bu-print.gif" value="Print" onclick="javascript: printquoteDetails(<?php echo $quoterecnum ?>)">
...
<?php
    ...
    ?>
       ...
       <td><form action='processSalesorder.php' method='post'>
             <INPUT TYPE="image" src="images/csa.gif" VALUE="Submit now" ALT="submit" NAME="submit">
...
<a href ="quoteDetails.php?mail=new&quoterecnum=<?php echo $quoterecnum ?>" ><img name="Image8" border="0" src="images/sendmail.gif"  ALT="send mail" ></a>
       ...
       <table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
         ...
         <tr bgcolor="#FFFFFF">
            ...
            <?php
             ...
             printf('%s%.2f</td>',$myrow[11],$myrow[29]);
            ...
            <input type="hidden" name="misc" value="<?php echo  $myrow[21]?>">
