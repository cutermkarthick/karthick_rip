...
<td colspan=15><span class="heading"><center><b>Line Items</b></center></td>
       ...
       <tr>
            ...
            <td bgcolor="#EEEFEE" width=10%><span class="heading"><b>Unit Price</b></td>
            <td bgcolor="#EEEFEE" width=6%><span class="heading"><b>Total Price</b></td>
       </tr>
...
<?php
        ...
        while ($myLI = mysql_fetch_assoc($result)) {
            ...
            $Price = $unit_price*$qty;
             ...
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$unit_price</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$Price</td>";
        }
?>
