...
$_SESSION['pagename'] = 'allotcrn_summary';
//////session_register('pagename');

// First include the class definition
include_once('classes/userClass.php');
include_once('classes/allot_crnclass.php');
...
<table width=100% border=0>
  <tr>
  <td><span class="pageheading"><b>List Of PRN</b></td>
  <td colspan=160>&nbsp;</td>
  <td><a href ="new_allotcrn.php"><img name="Image8" border="0" src="images/new_crn.gif"></a>
  </td>
  </tr>
</table>
     ...
     $result = $newcrn->getallotcrns();
           ...
           /*   $d=substr($myrow[5],8,2);
   	       ...
   	       printf('<tr bgcolor="#FFFFFF"><td><span class="tabletext">
                           <a href="allotcrn_details.php?allot_crnrecnum=%s">%s</td>
