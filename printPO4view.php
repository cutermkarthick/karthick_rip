...
<tr class="bgcolor2" bordercolor="#CCCCCC" >
            ...
            <td bgcolor="#EEEFEE"><span class="heading"><b>Mts<br> req</b></td>
...
?>
          ...
          <tr>
         <!-- <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=16 align="right"><span class="tabletext"><b>Total</b></td>
              <td align="right" bgcolor="#FFFFFF"><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["poamount"]); ?></td>
          </tr>
          <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=16 align="right"><span class="tabletext"><b>Tax</b></td>
              <td align="right" bgcolor="#FFFFFF"><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["tax"]);  ?></td>
          </tr>
          <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=16 align="right"><span class="tabletext"><b>Shipping</b></td>
              <td align="right" bgcolor="#FFFFFF"><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["shipping"]); ?></td>
          </tr>
          <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=16 align="right"><span class="tabletext"><b>Labor</b></td>
              <td align="right" bgcolor="#FFFFFF"><span class="tabletext"><?php printf('%s %.2f',$myrow["currency"],$myrow["labor"]); ?></td>
          </tr>
          <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=16 align="right"><span class="tabletext"><b>Total Due</b></td>
              <td align="right" bgcolor="#FFFFFF"><span class="tabletext"><b><?php printf('%s %.2f',$myrow["currency"],$myrow["total_due"]); ?></b></td>
          </tr>
          <tr class="bgcolor2" bordercolor="#CCCCCC" >
              <td bgcolor="#FFFFFF" colspan=17 border=none><span class="tabletext"><b><center>This Order is approved electronically, hence no signature is required</center></b></td>
          </tr>  -->
<tr>
<?php
