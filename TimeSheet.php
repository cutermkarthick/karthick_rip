...
<h2 class="table"><span>List of Upload TimeSheet

<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='TimesheetUpload.php'" value="New Upload" >
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='TimesheetImport.php'" value="New Import" >
            ...
            <thead>
              ...
              <th class="head1"><span class="heading"><b>File Name</b></span></th>
						...
						<?php
							...
							$newlogin->dbconnect();
							$result = $newAttendance->getUploadAttendance();
							while ($myrow = mysql_fetch_row($result))
							{
					  		printf('
					  			<tr>
                  	<td bgcolor="#FFFFFF"><span class="tabletext"><a href="AttendanceUploadDetails.php?recnum=%s"><b>%s</b></td>
