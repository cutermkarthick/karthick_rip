...
//echo "$porecnum";
$_SESSION['pagename'] = 'assypoDetails';
...
<td align="right">
             <td align="right"><a href ="assypoEdit.php?delrecnum=<?php echo $delrecnum ?>" ><img name="Image8" border="0" src="images/bu-edit.gif" ></a>
             <img src="images/bu-print.gif" alt="Print Po" onClick="javascript: printCofc(<?php echo $delrecnum ?>)">
        </td>
  </tr>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
    <tr bgcolor="#FFFFFF">
	 ...
	 <tr bgcolor="#FFFFFF">
<td width=20%><span class="labeltext"><p align="left">Approval By</td>
<td colspan=3><span class="tabletext"><?php echo $myrow["approval_by"]?></td>
           ...
           // echo "$date";
            ...
            <td colspan=3><span class="tabletext"><textarea  name="amendment_notes" id="amendment_notes" rows="3"
			              ...
			              cols="120" value=""><?php echo $amend_notes." \n"?></textarea></td>
			</tr>
			<tr bgcolor="#FFFFFF">
            <td width=20%><span class="labeltext"><p align="left">PO Desc</p></font></td>
            <td colspan=3><span class="tabletext"><?php echo $myrow["po_desc"] ?></td>
			</tr>
         ...
         ?>
            ...
            <td colspan=3 bgcolor=<?php echo $color ?>><span class="tabletext"><b><?php echo $myrow["status"] ?></b></td>
			</tr>
			<tr bgcolor="#FFFFFF">
			<td width=20%><span class="labeltext"><p align="left">Type</p></font></td>
            <td colspan=3><span class="tabletext"><b><?php echo $myrow["type"] ?></b></td>
		...
		<tr bgcolor="#FFFFFF">
           ...
           <td colspan=3><span class=\"tabletext\"><textarea  name="remarks" rows="3"
                          style="background-color:#DDDDDD;" readonly="readonly"
			              cols="120" value=""><?php echo $remarks." \n" ?></textarea></td>
</tr>
        </tr>
...
<?php
        ...
        while ($myLI = mysql_fetch_assoc($result)) {
			...
			$mtlSpec1=wordwrap($mtlSpec,15,"<br/>\n",true);
	     ...
	     echo"<tr><td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$line_num</td>" ;
             ...
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$pripartNum1</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$secpartNum1</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$partName1</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$partIss</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$drg</td>";
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$mtlSpec1</td>";
             ...
             echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$currency  $extPrice</td>";
