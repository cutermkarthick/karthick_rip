...
$myQI = $suppquoteli->getQI($quoterecnum);
$result = $newsuppQuote->getSupplierQuote($quoterecnum);
$myrow = mysql_fetch_row($result);
$revisionnum = $newsuppQuote->getRevnum($quoterecnum);
$myQ2 = $suppquoteli->getQI($quoterecnum);
...
<input type= "button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px" value="Print" onclick="javascript: printSuppQuoteDetails(<?php echo $quoterecnum ?>)">
...
<input type="button" class="stdbtn btn_blue" style="padding:2px;float:right;margin-right:5px" onclick="location.href='suppquoteDetails.php?mail=new&quoterecnum=<?php echo $quoterecnum ?>'"  value="Send Mail">

  <?php
    if($myrow[27] == ''){
        ?>
        <input type="button" class="stdbtn btn_blue" style="padding:2px;float:right;margin-right:5px" onclick="location.href='SuppQuoteRevise.php?quoterecnum=<?php echo $quoterecnum ?>&revisionnum=<?php echo $revisionnum ?>'"  value="Revise">
 ...
 <?php
    if($myrow[27] == ''){
        ?>
           ...
           ?>
<input id="a" type="button" class="stdbtn btn_blue" style="padding:2px;float:right;margin-right:5px" onclick="location.href='SuppQuoteEdit.php?quoterecnum=<?php echo $quoterecnum ?>'"  value="Edit Quote">
