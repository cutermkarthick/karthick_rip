...
$_SESSION['pagename'] = 'new_partwise_req';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="achieved" size=20 value=""></td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Balance</p></font></td>
            <td><span class="tabletext"><input type="text" name="balance" size=20 value=""></td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td colspan=3><span class="tabletext"><input type="text" name="status" size=20 value=""></td>
        </tr>
