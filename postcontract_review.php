...
$_SESSION['pagename'] = 'postReviewSummary';
...
<tr>
  ...
  <h2 class="table"><span>List of Contract Review <?php echo $cname_match;?>
    <input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:2px;"  onClick="location.href='postcontractNew.php'" value="New" ></h2></span>
 <!-- 
</div>  
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"postcontract_review.php?page=$page&totpages=$totpages&final_cust_po=$finalcust_po_match&ddate1=$ddate1_match&ddate2=$ddate2_match&cname=$cname_match&salesorder_oper=$oper\">[Prev]</a> ";

    $first = " <a href=\"postcontract_review.php?page=1&totpages=$totpages&final_cust_po=$finalcust_po_match&ddate1=$ddate1_match&ddate2=$ddate2_match&cname=$cname_match&salesorder_oper=$oper\">[First Page]</a> ";
}
else
{
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"postcontract_review.php?page=$page&totpages=$totpages&final_cust_po=$finalcust_po_match&ddate1=$ddate1_match&ddate2=$ddate2_match&cname=$cname_match&salesorder_oper=$oper\">[Next]</a> ";

    $last = " <a href=\"postcontract_review.php?page=$totpages&totpages=$totpages&final_cust_po=$finalcust_po_match&ddate1=$ddate1_match&ddate2=$ddate2_match&cname=$cname_match&salesorder_oper=$oper\">[Last Page]</a> ";
}
else
{
