...
$_SESSION['pagename'] = 'edit_custpoedit';
...
<form action='processcustpoedit_notes.php' method='post'>
...
<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3>
    ...
    <input type="hidden" name="companyrecnum" value="<?php echo $myrow[24]?>"></td>
           ...
           <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="quote_num" size=20 value="<?php echo $myrow[39]?>" readonly></td>
        </tr>
            ...
            <td colspan=4><textarea name="special_instruction"
			        style="background-color:#DDDDDD;"
                    rows="4"  cols="45" readonly><?php echo $myrow[7] ?></textarea></td>
            </tr>

            <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Description</p></font></td>
            <td><input type="text" name="description" size=36 value="<?php echo $myrow[3]?>" readonly></td>
             ...
             <option value disabled>Rs </option>
             </select>
           </tr>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="amendmentnum" size=20 value="<?php echo $myrow[45]?>" readonly></td>
	    ...
	    <tr bgcolor="#FFFFFF">
            ...
            <td colspan=3><span class="tabletext"><input type="text" name="status" size=15  readonly value="<?php echo $myrow[47] ?>">
      <!--
      ...
      <tr bgcolor="#FFFFFF">
            ...
            <td colspan=3><input type="text" name="contact" size=20 value="<?php echo $myrow[37] ?>" readonly></td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="email" size=20 value="<?php echo $myrow[29]?>" readonly></td>
            <td><span class="labeltext"><p align="left">Phone</p></font></td>
            <td><input type="text" name="phone" size=20 value="<?php echo $myrow[38]?>" readonly></td>
        </tr>
   ...
   while($i<=40)
	{
		if($flag==0)
		{
		 ...
		 while ($QI = mysql_fetch_row($myQI))
			...
			echo "<td><span class=\"tabletext\"><input type=\"text\" id=\"$linenumber\"  name=\"$linenumber\"  value=\"$QI[0]\" readonly size=\"4%\"></td>";
			echo "<td><span class=\"tabletext\"><input type=\"text\"  id=\"$crn_num\" name=\"$crn_num\"  style=\"background-color:#DDDDDD;\"
							...
							/*
                      <img src=\"images/getcim.gif\" onclick=\"GetCrn4Soli('$i')\">*/
					  echo "</td>";
	    ...
	    echo "<td ><input type=\"text\" id=\"$drgiss\" name=\"$drgiss\" size=\"10%\" value=\"$drgissvalue\" readonly></td>";
	    $partissvalue = htmlspecialchars($QI[9]);
            echo "<td ><input type=\"text\" id=\"$partiss\" name=\"$partiss\" size=\"10%\" value=\"$partissvalue\" readonly></td>";
	    ...
	    $cosissvalue = htmlspecialchars($QI[25]);
            echo "<td ><input type=\"text\" id=\"$cos_iss\" name=\"$cos_iss\" size=\"10%\" value=\"$cosissvalue\" readonly></td>";

            echo "<td ><input type=\"text\" id=\"$model_iss\" name=\"$model_iss\" size=\"10%\" value=\"$QI[16]\" readonly></td>";
           // echo "<td ><input type=\"text\" name=\"$hcdrgiss\" size=\"10%\" value=\"$QI[15]\"></td>";
	        echo "<td ><input type=\"text\" id=\"$qty\" name=\"$qty\" size=\"6%\" value=\"$QI[2]\" readonly></td>";

	        
	      if($_SESSION['department'] == 'Sales')
		  {
	        
            echo "<td ><input type=\"text\" id=\"$price\" name=\"$price\" size=\"10%\" value=\"$QI[3]\" readonly></td>";
            ...
            echo "<td ><input type=\"text\" id=\"$mcprice\" name=\"$mcprice\" size=\"10%\" value=\"$QI[13]\" readonly></td>";
            echo "<td><input type=\"text\" id=\"$mcamount\" name=\"$mcamount\" style=\"background-color:#DDDDDD;\"
            	            readonly=\"readonly\" size=\"10%\" value=\"$QI[14]\">";
           }
            else
            {
            	                      echo "<input type=\"hidden\" id=\"$price\" name=\"$price\" size=\"10%\" value=\"$QI[3]\" readonly>";
            ...
            echo "<input type=\"hidden\" id=\"$rmamount\" name=\"$rmamount\" style=\"background-color:#DDDDDD;\"
            	            readonly=\"readonly\" size=\"10%\" value=\"$QI[12]\" >";
            echo "<input type=\"hidden\" id=\"$mcprice\" name=\"$mcprice\" size=\"10%\" value=\"$QI[13]\" readonly>";
 ...
 <td width="6"><img src="images/spacer.gif " width="6"></td>
     ...
     <input type="hidden" name="salesorderrecnum" value="<?php echo $myrow[0] ?>">
               <span class="labeltext"><input type="submit"
                     ...
                     value="Submit" name="submit" onclick="javascript: return custpoedit_notes('edit_custpoedit')">
                <INPUT TYPE="RESET"
                     style="color=#0066CC;background-color:#DDDDDD;width=130;"
