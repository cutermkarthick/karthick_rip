...
$_SESSION['pagename'] = 'rmeditmaster';
...
<td><input type="text" name="rm_uom" size=10 value='<?php echo $myrow["rm_uom"] ?>' style=";background-color:#DDDDDD;"
readonly="readonly">
...
<option value="Active" <?php if($myrow["rm_status"] == 'Active') echo $selected?>>Active</option>
