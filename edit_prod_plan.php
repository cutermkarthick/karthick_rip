...
$_SESSION['pagename'] = 'edit_prod_plan';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="status" size=20 value="<?php echo $myrow[7] ?>"></td>
        </tr>


<input type="hidden" name="prod_planrecnum" value="<?php echo $prod_planrecnum ?>">
</table>
</table>
