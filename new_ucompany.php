...
// Filename: new_ucompany.php                  =
// Copyright (C) FluentSoft Inc.               =
// Contact bmandyam@fluentsoft.com             =
// Revision: v1.0 OMS                          =
// Allows entry of new companies for user      =
//==============================================
											...
											<td>
  												<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
												        <tr bgcolor="#FFFFFF"  >
            													...
            													<td><span class="labeltext"><input type="text" name="cname" size=30 value=""></td>
           										 			<td><span class="labeltext"><p align="left">ID</p></font></td>
           										 			<td><input type="text" name="cid" size=30 value=""></td>
        												         </tr>
        											 	       <tr bgcolor="#FFFFFF">
      										  		      ...
      										  		      <tr bgcolor="#EEEFEE"><span class="heading"><td colspan=4><center><b>Primary Address</b></center></td></tr>
												     <tr bgcolor="#FFFFFF">
        												    ...
        												    <tr bgcolor="#FFFFFF">
        												     ...
        												     <tr bgcolor="#EEEFEE"><span class="heading"><td colspan=4><center><b>Billing Address</b></center></td></tr>
        									 				<tr bgcolor="#FFFFFF">
          								  						<td><span class="labeltext"><p align="left">Address1</p></font></td>
       									 				...
       									 				<tr bgcolor="#EEEFEE"><span class="heading"><td colspan=4><center><b>Shipping Address</b></center></td></tr>
       							 						<tr bgcolor="#FFFFFF">
         									   					<td><span class="labeltext"><p align="left">Address1</p></font></td>
