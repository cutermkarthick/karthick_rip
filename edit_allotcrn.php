...
$_SESSION['pagename'] = 'edit_allotcrn';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="file" name="attachments" size=20 value="<?php echo $myrow[4] ?>">
            </td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">DRG Issue</p></font></td>
            <td colspan=3><input type="text" name="drg_issue" size=20 value="<?php echo $myrow[5] ?>"></td>
        </tr>

<input type="hidden" name="action" value="edit">
<input type="hidden" name="allot_crnrecnum" value="<?php echo $allot_crnrecnum ?>">
