...
$_SESSION['pagename'] = 'edit_capacity_plan';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="av_cap" size=20 value="<?php echo $myrow[2] ?>"></td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Used capacity</p></font></td>
            <td><input type="text" name="used_cap" size=20 value="<?php echo $myrow[3] ?>"></td>
            <td><span class="labeltext"><p align="left">Unused capacity</p></font></td>
            <td><input type="text" name="unused_cap" size=20 value="<?php echo $myrow[4] ?>">
        </tr>

<input type="hidden" name="capacity_planrecnum" value="<?php echo $capacity_planrecnum ?>">
</table>
</table>
