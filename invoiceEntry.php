...
<!-- <table width=100% cellspacing="0" cellpadding="6" border="0">
 ...
 <table width=100% border=0>
    ...
    <img src="images/bu-delete.gif" value="Get" onclick="entercustinv()">
	</td>
    </table>
  <tr>
<td>
...
<?php
    ...
    echo "<td ><input type=\"text\" name=\"$crn\" id=\"$crn\" size=\"10\"  style=\"background-color:#DDDDDD;\"
		  		readonly=\"readonly\" value=\"\"><img src=\"images/getcim.gif\" width=\"90px\" height=\"20px\" alt=\"Get CRN\"  onclick=\"GetCRN4invoice($i)\"></td>";
  ...
  echo "<td ><input type=\"text\" name=\"$cofc\" id=\"$cofc\" size=\"10\" value=\"\" style=\"background-color:#DDDDDD;\" readonly=\"readonly\"><img src=\"images/bu-get.gif\" alt=\"Get CofC\"  width='80px' onclick=\"getcofc($i)\"></td>";
  echo "<td ><input type=\"text\" name=\"$ponum\" id=\"$ponum\" size=\"10\" style=\"background-color:#DDDDDD;\"
    ...
    echo "<td ><input type=\"text\" name=\"$qty\" id=\"$qty\" size=\"3\" value=\"\"></td>";
