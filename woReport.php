...
<tr bgcolor="DEDFDE">
    ...
    <table width=100% border=0>
       <tr><td><span class="heading"><b>WO Report</b></td>
       <td colspan=210>&nbsp;</td>
        <td ><a href="javascript:printBordreport()"><img name="Image7" border="0" src="images/bu-print.gif"></a></td>
        </tr>
    </table>
...
<tr><td><span class="pageheading"><b>Status of Board Open Work Orders</b></td></tr>
...
<?php
         $numstages = 0;
         $result = $newreport->getWFstages('Aerowings');
...
<?php
            ...
            $result = $newreport->getWOs('Aerowings',$cond,$offset, $rowsPerPage);
...
$numrows = $newreport->getWOcount($offset, $rowsPerPage,'Board');
