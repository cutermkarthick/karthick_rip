...
<td><span class="pageheading"><b>Master data</b><td colspan=250></td>
    ...
    <?php
    //echo$dept."in view";
    if(($dept=='Sales' ||$dept=='PPC3')&& $myrow["status"] !='Inactive')
    {
    ?>
    <input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onclick="location.href='edit_master_data.php?masterdatarecnum=<?php echo $masterdatarecnum ?>'" value="Edit Master">
     ...
     <?php
    //echo$dept."in view";
    if($dept=='ENGAPP' && $myrow["status"] !='Inactive')
    {?>
        <a href ="masterData_eng.php?masterdatarecnum=<?php echo $masterdatarecnum ?>" ><img name="Image8" border="0" src="images/bu_editmaster.gif" ></a>
     <?php
     }?>
...
<tr bgcolor="#659EC7"><td colspan=4><span class="heading"><center><b>Master Data Details</b></center></td></tr>
 ...
 <tr bgcolor="#FFFFFF"></tr>
         <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><?php echo $myrow["drawing_num"] ?>
            </td>
        </tr>
...
?>
	  ...
	  <td width=10% bgcolor="#FFFFFF" align=center><span class="tabletext"><?php echo $myrow4mps[2] ?></td>
	  <td width=15% bgcolor="#FFFFFF" align=center><span class="tabletext"><?php echo $myrow4mps[5] ?></td>
	  <td width=12% bgcolor="#FFFFFF" align=center><span class="tabletext"><?php echo $rev_date ?></td>
  ...
  ?>
        ...
        <tr bgcolor="#FFFFFF">
         ...
         <tr bgcolor="#FFFFFF">
            ...
            <td colspan="3"><span class="tabletext"><?php echo $rm_cond ?></td>
        ...
        ?>
          <tr bgcolor="#FFFFFF">
            ...
            <td bgcolor="#FFFFFF"><input type="checkbox" <?php echo $myrow_rm["enggapproved"] == 'yes'?$checked:"" ?>  id="engineering_approved" name="engineering_approved" disabled onClick="return readOnlyCheckBox()">
                         ...
                         <input type="hidden" name="masterdatarecnum" id="masterdatarecnum" value="<?php echo $masterdatarecnum?>"></td></td>
            <td><span class="labeltext">Engineering Approved By</td>
            <td><span class="tabletext"><?php echo $myrow_rm["engapprovedby"] ?></td>
          </tr>
        ...
        ?>
          <tr bgcolor="#FFFFFF">
            ...
            <td bgcolor="#FFFFFF"><input type="checkbox" <?php echo $myrow_rm["directorsapproved"] == 'yes'?$checked:"" ?>  id="directors_approved" name="directors_approved" disabled onClick="return readOnlyCheckBox()">
                         <input type="hidden" name="director_app" value="<?php echo $myrow_rm["directorsapproved"]?>" id="director_app">
                         <input type="hidden" name="masterdatarecnum" id="masterdatarecnum" value="<?php echo $masterdatarecnum?>"></td></td>
            <td><span class="labeltext">Directors Approved By</td>
            <td><span class="tabletext"><?php echo $myrow_rm["directorsapprovedby"] ?></td>
