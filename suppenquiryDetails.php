...
// Filename: suppenquiryDetails.php            =
...
<td><span class="pageheading"><b>Enquiry Details</b><td colspan=250></td>
    <td bgcolor="#FFFFFF" rowspan=2 align="right">
        ...
        <input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:2px;" onClick="location.href='edit_suppenquiry.php?recnum=<?php echo $recnum ?>'" value="Edit Enquiry" >
          <!-- <a href ="edit_enquiry.php?enquiryrecnum=<?php echo $enquiryrecnum ?>" ><img name="Image8" border="0" src="images/bu_editenquiry.gif" ></a> -->
          <input type= "button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:2px;" value="Print" onclick="javascript: printSuppEnquiryDetails(<?php echo $recnum ?>)">
</td>
  </tr>
