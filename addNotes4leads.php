...
$_SESSION['pagename'] = 'addnotes4leads';
...
<FORM ACTION = "processNotes4leads.php" METHOD = "POST">
<?php
include('header.html');
?>
										...
										<tr>
											<td>
  												<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
												       <tr bgcolor="#EEEFEE"><span class="heading"><td colspan=4><center><b>Leads Notes</b></center></td></tr>
												       <tr bgcolor="#FFFFFF"  >
