...
if (( $fdate !='' && $fdate !='0000-00-00' ) ||  ( $tdate !='' && $tdate !='0000-00-00' ) )
{
     ...
     else
     {
          ...
          $condw1 = "(to_days(w.book_date)-to_days('1582-01-01') > 0 || w.book_date is null ||w.book_date = '0000-00-00')";
     ...
     else
     {
          ...
          $condw2 = "(to_days(w.book_date)-to_days('2050-12-31') < 0 || w.book_date is null || w.book_date = '0000-00-00')";
     }
...
$conversionrate=0;
        ...
        $total_conversion=0;
        $result = $newreport->get_stockbygrn4dir_exp($cond);
        ...
        }  else
        {
          ...
          $data .='<tr>';
              ...
              $data .='<td bgcolor="#FFFFFF" align="center"><span class="tabletext">'.$recddate.'</td>
                    ...
                    <td bgcolor="#FFFFFF" align="center"><span class="tabletext">'.$myrow[7].'</td>
                    <td bgcolor="#FFFFFF" align="center"><span class="tabletext">'.$myrow[8].'</td>';
...
header("Content-Disposition: attachment; filename=stockgrn_export.xls",false);
