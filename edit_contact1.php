...
?>
            ...
            <td><span class="labeltext"><p align="left">Lead ID</p></font></td>
            <td><span class="tabletext"><?php echo $myrow[4] ?></td>
            <td><span class="labeltext"><p align="left">Lead Source</p></font></td>
            <td><input type="text" name="company"
                    style=";background-color:#DDDDDD;"
                    readonly="readonly" size=20 value="<?php echo $myrow[15] ?>"> <img src="images/bu-getcompany.gif" alt="Get Company"                                                   onclick="GetEmployer()">
             <input type="hidden" name="companyrecnum" value="<?php echo $myrow[17] ?>">
            </td>

        </tr>
          <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Lead Source Description</p></font></td>
            <td><input type="text" name="fname" size=20 value="<?php echo $myrow[0] ?>"</td>
            <td><span class="labeltext"><p align="left">Refered by</p></font></td>
        ...
        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Address </p></font></td>
       ...
       <tr bgcolor="#FFFFFF">
           ...
           <td><input type="text" name="state" size=20 value="<?php echo $myrow[11] ?>"</td>
            <td><span class="labeltext"><p align="left">Mobile</p></font></td>
            <td><input type="text" name="zipcode" size=20 value="<?php echo $myrow[12] ?>"</td>
        </tr>
