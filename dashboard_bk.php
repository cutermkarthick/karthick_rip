...
<tr><td valign='top'>
<div id='schedule' style="width:524px; overflow:auto;height:300;">
<table  width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
<tr>
...
<input type="text" size=15% name="crn_schedule" id="crn_schedule" value="prn1"></td>
...
<th width="60px"  class="head1"><span class="labeltext"><b>DN (fg)</b></th>
...
?>
<table  style="table-layout: fixed" width="590px" border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable">
<tr>
<thead>
<th width="90px"  class="head0"><span class="labeltext" align="center"><b>PRN</b></th>
...
{ 
  ...
  {    
      ...
      else
    {
      ...
      if($prevcrn!=$crn)
      {
          echo "<td align=\"center\" bgcolor=\"#FFFFFF\"  width=\"50px\"><span class=\"tabletext\">$crn</td>";
      }
      else{
      echo "<td align=\"center\" bgcolor=\"#FFFFFF\"  width=\"50px\"><span class=\"tabletext\">&nbsp;</td>";
}
      echo "<td align=\"center\" bgcolor=\"#FFFFFF\"  width=\"50px\"><span class=\"tabletext\">$schdate</td>";
        echo "<td align=\"center\" bgcolor=\"#FFFFFF\" width=\"50px\"><span class=\"tabletext\">$qtyreq($shortfall)</td>";
      echo "<td align=\"center\" bgcolor=\"#FFFFFF\"  width=\"50px\"><span class=\"tabletext\">$date2</td>";
      echo "</tr>";
      $prevcrn=$crn;
      $fg = 0;
      $grn = 0;
...
<td colspan=6 align="center" bgcolor="#bababa"><span class="heading"><b>This Week Dispatch</b></td>
       ...
       <tr>
<td valign='top' bgcolor="#FFFFFF"><span class="labeltext"><b>PRN:</b>&nbsp;
<input type="text" size=15% name="crn_disp" id="crn_disp" value="prn1"></td>
<td  bgcolor='#FFFFFF'> <img src="images/bu-get.gif" value="Get"
