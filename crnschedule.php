...
<form action='crnschedule.php' method='post' enctype='multipart/form-data'>
<?php
...
<tr bgcolor="#FFCC00">
<td width="90px"  align="center" bgcolor="#EEEFEE"><span class="labeltext" align="center"><b>PRNnnn</b></td>
...
//printf('<td  width="115px" align="center" bgcolor="#FFFFFF"><span class="labeltext">%s</td>',$proc);
$results = $newreport->getallCRN4open($myrow4crn[1],$proc);
if(mysql_num_rows($results) == '0')
{

  //printf('<td width="50px" align="center" bgcolor="#FFFFFF"><span class="labeltext">%s</td>','&nbsp');
}
