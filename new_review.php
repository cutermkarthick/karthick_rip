...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
           ...
           <td><input type="text" name="name"
                    ...
                    readonly="readonly" size=35 value="">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="orderdate" size=20 value="" readonly="readonly" style="background-color:#DDDDDD;">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="created_by" size=30 value=""  </td>
...
<?php
   ...
   // $hc_cos="hc_cos" . $i;
	...
	$mcprice="mcprice" . $i;
	$mcamount="mcamount" . $i;
	echo "<td><span class=\"tabletext\"><input type=\"text\" id=\"$line_num\" name=\"$line_num\"  value=\"\" size=\"10\"></td>";
	echo "<td><span class=\"tabletext\"><input type=\"text\" id=\"$crn_num\" name=\"$crn_num\"  value=\"\" size=\"15\"></td>";
    echo "<td><input type=\"text\" id=\"$partnum\" name=\"$partnum\" size=\"15\" value=\"\"></td>";
    echo "<td><input type=\"text\" id=\"$item_desc\" name=\"$item_desc\" size=\"10\" value=\"\"></td>";
    ...
    echo "<td><input type=\"text\" id=\"$gf\" name=\"$gf\" size=\"10\" value=\"\"></td>";
    echo "<td><input type=\"text\" id=\"$maxruling\" name=\"$maxruling\" size=\"10\" value=\"\"></td>";
    echo "<td><input type=\"text\" id=\"$altspec\" name=\"$altspec\" size=\"10\" value=\"\"></td>";
...
<span class="labeltext">
               <!-- <input type="button"
                ...
                <input type="submit"
                style="color=#0066CC;background-color:#DDDDDD;width=130;"
                value="Submit" name="submit" onclick="javascript:return check_req_fields('new_review');">
                <INPUT TYPE="RESET"
                style="color=#0066CC;background-color:#DDDDDD;width=130;"
