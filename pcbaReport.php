...
<tr><td><span class="heading"><b>Pcba Report</b></td>
<td colspan=210>&nbsp;</td>
<td><a href="javascript:printPcbareport()"><img name="Image7" border="0" src="images/bu-print.gif"></a></td>
</tr>
</table>
...
<tr><td><span class="pageheading"><b>Status of PCBA Open Work Orders</b></td></tr>
...
<?php
         $numstages = 0;
         $result = $newreport->getWFstages('PCBA');
...
<?php
            ...
            $result = $newreport->getWOs('PCBA',$cond,$offset, $rowsPerPage);
...
$numrows = $newreport->getWOcount($offset, $rowsPerPage,'PCBA');
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"pcbaReport.php?page=$page&totpages=$totpages\">[Prev]</a> ";

    $first = " <a href=\"pcbaReport.php?page=1&totpages=$totpages\">[First Page]</a> ";
}
else
{
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"pcbaReport.php?page=$page&totpages=$totpages\">[Next]</a> ";

    $last = " <a href=\"pcbaReport.php?page=$totpages&totpages=$totpages\">[Last Page]</a> ";
}
else
{
