...
$_SESSION['pagename'] = 'bom_summary';
//////session_register('pagename');

// First include the class definition
include_once('classes/userClass.php');
include_once('classes/part_bomclass.php');
...
<table width=100% border=0>
  <tr>
  <td><span class="pageheading"><b>List Of BOM</b></td>
  <td colspan=160>&nbsp;</td>
  <td><a href ="new_bom.php"><img name="Image8" border="0" src="images/new_bom.gif"></a>
  </td>
  </tr>
</table>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        <tr bgcolor="#FFCC00">
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Part Unit</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>RM Spec</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>RM Units</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Req RM Qty</b></td>
        </tr>


<?php

            $result = $newPB->getallpart_boms();

            while ($myrow = mysql_fetch_row($result)) {


   	       printf('<tr bgcolor="#FFFFFF"><td ><span class="tabletext">
                          <a href="bom_details.php?part_bomrecnum=%s">%s</td>
