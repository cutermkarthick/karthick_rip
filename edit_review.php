...
// Revision: v1.0 OWT                          =
// Allows editing of Review Order details      =
//==============================================
...
<?php $newdisplay->dispLinks(''); ?>
 ...
 <table width=100% border=0>
	<td width="100%"><span class="pageheading"><b>Edit review</b></td>
    <td colspan=20>&nbsp;</td>
...
<tr bgcolor="#DDDEDD"><td colspan=4><span class="heading"><center><b>Edit review Details</b></center></td></tr>
 ...
 <table width=100% border=0 cellpadding=4 cellspacing=1 bgcolor="#DFDEDF">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="name"
                    ...
                    readonly="readonly" size=35 value="<?php echo $myrow["name"]?>"">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="ordernum" size=30 value="<?php echo $myrow["ordernum"] ?>"></td>
  ...
  ?>
   <td bgcolor="#FFFFFF"><input type="checkbox" <?php echo $myrow["qa_approved"] == 'yes'?$checked:"" ?> name="qa_approved"  <?php echo $check; ?> onclick="JavaScript:toggleValue('qa_app',this);">
   ...
   <td bgcolor="#FFFFFF"><input type="checkbox" <?php echo $myrow["engineering_approved"] == 'yes'?$checked:"" ?>  name="engineering_approved" <?php echo $check; ?>  onclick="JavaScript:toggleValue('eng_app',this);">
     ...
     <td><span class="tabletext"><input type="text" name="status"
                style="background-color:#DDDDDD;" readonly="readonly"  value="<?php echo $myrow["status"] ?>"
	<span class="tabletext"><select name="ordstat" size="1" width="20" onchange="onSelectStatus()">
   ...
   while($i<=40)
	{
		if($flag==0)
		{
		 while ($LI = mysql_fetch_row($myLI))
            ...
            echo "<td ><input type=\"text\" name=\"$partnum\" size=\"15%\" value=\"$LI[4]\"></td>";
...
//echo "i am in outside while loop";
        ...
        echo "<td><input type=\"text\" name=\"$partnum\" size=\"15%\" value=\"\"></td>";
...
<span class="labeltext"><input type="submit"
                ...
                value="Submit" name="submit" onclick="javascript:return check_req_fields('edit_review');">
                <INPUT TYPE="RESET"
                style="color=#0066CC;background-color:#DDDDDD;width=130;"
