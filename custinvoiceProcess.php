...
while($i<$max)
{
	...
	// 							echo "<pre>" ;
	// 				echo "Excise $excuse<br>" ;
	// 				echo "excisesubtotal $excisesubtotal<br>" ;
	// 				echo "totalamount $totalamount<br>" ;
	// 				echo "vatsubtotal $vatsubtotal<br>" ;
...
if($temp1 == 0)
	{
header("Location:custinvoiceSummary.php" );
	}else
	{
...
while($i<$max)
{
    ...
    //            if($flagst == 1)
               ...
               if($flagst == 1 || $flagc == 1)
                ...
                //echo$invoicerecnum."-***************".$prevlinenum1;
...
if ($pagename == 'custinvoicedetails') 
{
	$invoicerecnum=$_REQUEST['invoicerecnum'];
	//echo "<br>in processcust recnum is $invoicerecnum";
    $newinvoice->copyinvoice($invoicerecnum);
	header("Location:invoiceSummary.php" );
}
?>
