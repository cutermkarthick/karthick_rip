...
<html>
<head>
<title>APPENDIX-C Details</title>
</head>
...
<table width=100% cellspacing="0" cellpadding="6" border="0">
 ...
 <tr bgcolor="#FFFFFF">
	<td><span class="pageheading"><b>APPENDIX-C Details</b></td>
	<td bgcolor="#FFFFFF" align="right">
          <a href ="appendixcEdit.php?appendixcrecnum=<?php echo $apprecnum ?>" ><img name="Image8" border="0" src="images/bu_editinvoice.gif" ></a>
     <input type= "image" name="Print" src="images/bu-print.gif" value="Print" onclick="javascript: printappendixc(<?php echo $apprecnum ?>)"></td>
    </tr></table>
  <tr>
<td>
    ...
    <td colspan=1></td><td ><span class="labeltext">Bangalore - 560058, INDIA.</font></td>
              ...
              <td colspan=3>
                 ...
                 <tr bgcolor="#FFFFFF" >
            		...
            		<td colspan=3><span class="tabletext"><?php echo $myappendix["exportinvnum"]?></td>
                    </td>
                  </tr>
                     <tr bgcolor="#FFFFFF" >
                    <td><span class="labeltext"><p align="left"> &nbsp;&nbsp;&nbsp;(b)Total No. of packages:</p></font></td>
            		<td colspan=3><span class="tabletext"><?php echo $myappendix["totnumpkgs"]?></td>
                    </td>
                  </tr>
                     <tr bgcolor="#FFFFFF">
                    <td><span class="labeltext"><p align="left"> &nbsp;&nbsp;&nbsp;(c)Name and address of the consignee abroad:</p></font></td>
            		<td colspan=3><span class="tabletext"><?php echo $myrow1["name"]?></td>
