...
if($myrow[30]=='Rework')
{
echo "<td ><span class=\"tabletext\"><b>Work Order Ref#</b></td>
...
<!--        <td><a href ="javascript:displayShipment()"><?php // echo $link?></a>
	...
	while ($mytl = mysql_fetch_row($timeline)) 
	{
		...
		$secy_res = wordwrap($mytl[35],25,"<br>",true);
		

// echo $mytl[28] ."  ".$department;
      ...
      if($mytl[28] != $department)
        ...
        <?php echo $mytl[28];
			...
			{
			?>
			<td WIDTH=9%><span class="heading"><?php echo $mytl[38] ?></span></td>
			<?php
			}
			else 
			{
			...
			{
               // echo $mytl[29]." 1  ".$mytl[16] ." userrole ".$userrole ." dept ".$dept." myrow28 ".$mytl[28]. " myrow31 " .$mytl[31]."<br>";
				  // echo "<br>".$mytl[29]."---------- " .$mytl[16]."----1---2----".$edept."***------".$userrole;
			?>
			<td width=11%><span class="heading">
			<?php
			if(($mytl[29] == '' && $mytl[16] == '' && $userrole == 'SU' && $edept=='Sales') || ($mytl[29] == '' && $mytl[16] == '' && $userrole == 'RU' && $mytl[28] == $edept && $mytl[28] !='Purchasing')) 
			{
             // echo "reached";
			?>
   		...
   		else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'SU' && ($edept=='PPC') && ($mytl[31]=='240' || $mytl[31]=='270' || $mytl[31] == '280')) 
     	{
			?>
				<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
				<img src="images/bu_approval.gif" border=0>  
   		...
   		else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'OP' && ($edept=='PPC4'||$edept=='PPC5') && ($mytl[31]=='240' || $mytl[31]=='270' || $mytl[31] == '280')) 
     	{
			?>
				<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
				<img src="images/bu_approval.gif" border=0>  
			...
			else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'RU' && ($edept=='PPC6') && ($mytl[31]=='270')) 
			{
			?>
			<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
			<img src="images/bu_approval.gif" border=0>  
			...
			<td width=4%><span class="heading"><?php echo $secy_res ?></td>

			<td width=4%><textarea rows=3 cols=20 readonly="readonly"
			style="background-color: #DDDDDD; overflow-y: scroll;"><?php echo $mytl[36] ?></textarea></td>

			<td width=4%><textarea  rows=3 cols=20 readonly="readonly"
			style="background-color: #DDDDDD; overflow-y: scroll;" readonly="readonly"><?php echo $mytl[37] ?></textarea></td>
