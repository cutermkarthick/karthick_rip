...
//echo "ecorecnum  $ecorecnum";
$_SESSION['recnum'] =$ecorecnum; 
$_SESSION['pagename'] = 'eco'; 
	...
	<tr>
		<td>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0  >
				...
				<tr>
					<td>
					<?php $newdisp->dispLinks($ecorecnum); 
									...
									<table width=100% border=0 cellpadding=6 cellspacing=0  >
										<tr><td>
											 <table width=100% border=0>
												<tr>
													  <td><span class="pageheading"><b>ECO Details</b></td>
														 <td align=right><input type= "image" name="Delete" src="images/bu-print.gif" value="Print" onclick="javascript: printECO(<?php echo $ecorecnum ?>)"></td>
...
<tr bgcolor="#FFFFFF" >
          														  	...
          														  	<td colspan=3><span class="tabeltext"><?php echo "$myrow5[1]";?>
