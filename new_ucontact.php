...
<body leftmargin="0"topmargin="0" marginwidth="0">
     <form action='processuContact.php' method='post' enctype='multipart/form-data'>
<?php
include('header.html');
?>
...
?>
            ...
            <td><span class="tabletext"><input type="text" name="contactid" size=20 value=""></td>
...
<input type="hidden" name="companyrecnum">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="fname" maxlength="32"></td>
       ...
       <tr bgcolor="#FFFFFF">
         ...
         <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="phone" size=20 value=""><input type="hidden" name="roleval"></td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="address1" size=20 value=""></td>
        </tr>
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="city" size=20 value=""></td>
        </tr>
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="zipcode" size=20 value=""></td>
        </tr>
        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Country</p></font></td>
            <td><span class="tabletext"><input type="text" name="country" size=20 value=""></td>
