...
$_SESSION['pagename'] = 'newsuppQuote';
...
$QI = $suppquoteli->getQI($quoterecnum);
$result = $newsuppQuote->getSupplierQuote($quoterecnum);
$myrow = mysql_fetch_row($result);

?>
<link rel="stylesheet" href="style.css">
<script language="javascript" src="scripts/mouseover.js"></script>
<script language="javascript" src="scripts/suppquote.js"></script>

<html>
<head>
<title>Supplier Quote Details Edit</title>
</head>

<body leftmargin="0" opmargin="0" marginwidth="0">
<form action='processSuppQuote.php' method='post' enctype='multipart/form-data'>
<?php
include('header.html');
?>
      ...
      <tr bgcolor="#DDDEDD">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><input type="text" name="quoteid" size=20 style="background-color:#DDDDDD;" 
                       readonly="readonly" value="<?php echo $myrow[24],"-",$revisionnum ?>"></td>
            <input type="hidden" name="quoteid" value="<?php echo $myrow[24],"-",$revisionnum ?>">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="supplier"
             ...
             <img src="images/bu-get.gif" alt="Get Supplier" onclick="GetAllVendors()">
            </td>
             <input type="hidden" name="vendrecnum" value="<?php echo  $myrow[17]?>">
            ...
            <td><input type="text" name="salesperson"
             ...
             <img src="images/bu-get.gif" alt="Get Employee" onclick='GetAllEmps()'>
            </td>
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <input type="hidden" name="revisionnum" value=<?php echo $revisionnum ?>>
...
<table id="myTable" width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable" >
  <tr>
  <thead>
<th class="head0" bgcolor="#EEEFEE"><span class="heading"><b><center>Item</center></b></td>
<th class="head1" bgcolor="#EEEFEE"><span class="heading"><b><center>Description</center></b></td>
<th class="head0" bgcolor="#EEEFEE"><span class="heading"><b><center>Qty</center></b></td>
<th class="head1" bgcolor="#EEEFEE"><span class="heading"><b><center>Unit Price</center></b></td>
<th class="head0" bgcolor="#EEEFEE"><span class="heading"><b><center>Total</center></b></td>
</tr>
</thead>
<?php
	$i=1;
