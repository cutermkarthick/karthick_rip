...
$_SESSION['pagename'] = 'viewWoSummary';
...
include('header.html');
?>
<form action='viewWoSummary.php' method='post' enctype='multipart/form-data'>
...
<tr>
<td colspan=3 bgcolor="#FFFFFF"><span class="labeltext"><b>Sch Due:  From &nbsp&nbsp</b>
		...
		$woqty = $myrow[25];
            ...
            if ($flag == 0)
            {
   	       printf('<tr><td bgcolor="#FFFFFF"><span class="tabletext">
                           <a href="viewWoDetails.php?typenum=%s&wotype=%s&worecnum=%s&wonum=%s">%05d</td>
                      ',
...
?>
               ...
               <td bgcolor="#FFFFFF"><span class="tabletext"><?php echo $myrow[29] ?></td></tr>
       </tr>
 <!--
...
<?php
             ...
             {
                printf('<tr bgcolor="#EEEEEE"><td><span class="tabletext"><a href="viewWoDetails.php?typenum=%s&wotype=%s&worecnum=%s&wonum=%s">%05d</td>
                      ',
		         $myrow[7],$myrow[1],$myrow[11],$myrow[0],$myrow[0]
                     );
...
?>
               ...
               <td><span class="tabletext"><?php echo $myrow[29] ?></td></tr>
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"viewWoSummary.php?page=$page&totpages=$totpages&scomp=$company_match&status_val=$sval&swonum=$wonum_match&crn=$crn_match&sdate1=$date1_match&sdate2=$date2_match&stype=$type_match&sortfld1=$sort1&sortfld2=$sort2\">[Prev]</a> ";
    $first = " <a href=\"viewWoSummary.php?page=1&totpages=$totpages&scomp=$company_match&status_val=$sval&swonum=$wonum_match&crn=$crn_match&sdate1=$date1_match&sdate2=$date2_match&stype=$type_match&sortfld1=$sort1&sortfld2=$sort2\">[First Page]</a> ";
}
else
{
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"viewWoSummary.php?page=$page&totpages=$totpages&scomp=$company_match&status_val=$sval&swonum=$wonum_match&crn=$crn_match&sdate1=$date1_match&sdate2=$date2_match&stype=$type_match&sortfld1=$sort1&sortfld2=$sort2\">[Next]</a> ";
    $last = " <a href=\"viewWoSummary.php?page=$totpages&totpages=$totpages&scomp=$company_match&status_val=$sval&swonum=$wonum_match&crn=$crn_match&sdate1=$date1_match&sdate2=$date2_match&stype=$type_match&sortfld1=$sort1&sortfld2=$sort2\">[Last Page]</a> ";
}
else
{
