...
$_SESSION['pagename'] = 'custinvoicedetails';
...
<html>
<head>
<title>Cust Invoice Details</title>
</head>
...
<tr>
<td><span class="pageheading"><b>Customs Invoice Details</b><td colspan=250></td>
    <td bgcolor="#FFFFFF" rowspan=2 align="right">
	               <span class="labeltext"><input type="submit"
                     style="color=#0066CC;background-color:#DDDDDD;width=130;"
                     value="Copy to Invoice" name="Copy" >

    <td bgcolor="#FFFFFF" rowspan=2 align="right">
          <a href ="custinvoiceEdit.php?invoicerecnum=<?php echo $invoicerecnum ?>" ><img name="Image8" border="0" src="images/bu-edit.gif" ></a>
     <image name="Print" src="images/bu-print.gif" value="Print" onclick="javascript: printcustinvoiceDetails(<?php echo $invoicerecnum ?>)">
    <a href="exportcustinvoice.php?invoicerecnum=<?echo $_REQUEST['invoicerecnum']?>"><img name="Image8" border="0" src="images/export.gif" ></a></td>

  </tr>
   <input type="hidden" name="invoicerecnum" id="invoicerecnum" value="<?php echo $invoicerecnum; ?>">
...
?>
    ...
    <table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3>
      ...
      <!--  <tr bgcolor="#FFFFFF">
        ...
        <td colspan = 7><span class="labeltext"><p align="right">Service Tax:</p></font></td>
            <td align="right" ><span class="tabletext"><?php echo $myrow["service_tax"] ?></td> 
</tr> -->
        <tr bgcolor="#FFFFFF">
