...
$_SESSION['pagename'] = 'new_maintain_machine';
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="purpose" size=40 value=""></td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Task</p></font></td>
            <td><input type="text" name="task" size=20 value=""></td>
            <td><span class="labeltext"><p align="left">Task Time</p></font></td>
            <td><input type="text" name="task_time" size=20 value="">
        </tr>
        <tr bgcolor="#FFFFFF">
            ...
            <td ><input type="text" name="cost" size=20 value=""></td>
        </tr>
