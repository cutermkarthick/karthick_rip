      ...
      <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control item-menu" id="dept" name="dept" placeholder="Dept">
                </div>
              </div>
              <div class="form-group">
                <label for="urole" class="col-sm-2 control-label">User Role</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control item-menu" id="urole" name="urole" placeholder="User Role">
                </div>
              </div>
        ...
        jQuery(document).ready(function () {
            ...
            $('#btnSubmit').click(function(){
                ...
                else
                {
                  ...
                  type : "POST",
                  dataType: "html", 
                  data : "dept="+dept+"&urole="+urole+"&menus="+output+"&page="+page,
                  success : function (response)
                  {
                    if (response != 'Success') 
                    {
                     ...
                     return false;
                      ...
                      alert("Success New Menu Created \n");
