...
<html>
<head>
<title>Vendor Parts</title>
</head>
<body leftmargin="0"topmargin="0" marginwidth="0">
<form action='vendpart.php?' method='post' enctype='multipart/form-data'>
<?php
include('header.html');
...
<tr><td><span class="heading"><i>Please click on the Part link for details or to Edit/Delete</i></td></tr>
<tr>
	<td>
...
<td bgcolor="#FFFFFF" rowspan=4 align="center"><span class="tabletext">
<button class="stdbtn btn_blue" style="background-color:#2d3e50" onClick="javascript: return searchsort_fields()" >Get</button>
	<!-- <input type= "image" name="Get" src="images/bu-get.gif" value="Get" ></td> -->
</tr>
<tr>
...
<h2><span>Parts List
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px" onClick="location.href='new_vendPart.php'" value="New" >	
<!-- <a href ="new_vendPart.php"><img style="float:right" name="Image8" border="0" src="images/new.gif"></a> -->
</h2></span>
<tr><td>
<table style="width:100%" border=0 cellpadding=3 cellspacing=1 class="stdtable" >
 <thead>
      <tr>
            <th class="head0"><span class="heading"><b>Part #</b></td>
            <th class="head1"><span class="heading"><b>Type</b></td>
            <th class="head0"><span class="heading"><b>Part Desc </b></td>
            <th class="head1"><span class="heading"><b>Mfr/Vendor Part #</b></td>
            <th class="head0"><span class="heading"><b>Digi Part #</b></td>
            <th class="head1"><span class="heading"><b>Serial #</b></td>
            <th class="head0"><span class="heading"><b>Rate</b></td>
            <th class="head1"><span class="heading"><b>Min Qty</b></td>
            <th class="head0"><span class="heading"><b>Inv Count</b></td>
            <th class="head1"><span class="heading"><b>Vendor</b></td>
            <!--<td bgcolor="#EEEFEE"><span class="heading"><b>Where Used</b></td>-->
        </tr>
    </thead>

<?php

            $result = $newVend->getPartsort($cond,$sort1,$offset,$rowsPerPage);
             while ($myrow = mysql_fetch_row($result)) {
	$precnum='';
		// Added for po2Wo link enhancement on Dec 20
         printf('<tr><td bgcolor="#FFFFFF" align="center"><span class="tabletext"><a href="vendpartDetails.php?partrecnum=%s">%s</td>',
                      $myrow[0],$myrow[1]);
            if($myrow[15]=='BOM'){
            $bomrecnum=substr($myrow[1],1,1);
               printf('<td bgcolor="#FFFFFF" align="center"><span class="tabletext">BOM </td>');
                 }
           if($myrow[15]!='BOM'){
            ...
            printf('<td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>
                      ...
                      <td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>
                      <td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>
                      <td bgcolor="#FFFFFF" align="center"c><span class="tabletext">$%.2f</td>
                      <td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>
                      <td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>
                      <td bgcolor="#FFFFFF" align="center"><span class="tabletext">%s</td>',
	                  $myrow[10],$myrow[2], $myrow[3],$myrow[4],$myrow[6],$myrow[7],$myrow[12],$myrow[21]);
        }
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"vendpart.php?page=$page&totpages=$totpages&part_match=$part_match&desc_match=$desc_match&vend_match=$vend_match&mfr_match=$mfr_match&rate_match=$rate_match&part_oper=$part_oper&desc_oper=$desc_oper&vend_oper=$vend_oper&mfr_oper=$mfr_oper&rate_oper=$rate_oper\">[Prev]</a> ";

    $first = " <a href=\"vendpart.php?page=$page&totpages=$totpages&part_match=$part_match&desc_match=$desc_match&vend_match=$vend_match&mfr_match=$mfr_match&rate_match=$rate_match&part_oper=$part_oper&desc_oper=$desc_oper&vend_oper=$vend_oper&mfr_oper=$mfr_oper&rate_oper=$rate_oper\">[First Page]</a> ";
}
else
{
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"vendpart.php?page=$page&totpages=$totpages&part_match=$part_match&desc_match=$desc_match&vend_match=$vend_match&mfr_match=$mfr_match&rate_match=$rate_match&part_oper=$part_oper&desc_oper=$desc_oper&vend_oper=$vend_oper&mfr_oper=$mfr_oper&rate_oper=$rate_oper\">[Next]</a> ";

    $last = " <a href=\"vendpart.php?page=$page&totpages=$totpages&part_match=$part_match&desc_match=$desc_match&vend_match=$vend_match&mfr_match=$mfr_match&rate_match=$rate_match&part_oper=$part_oper&desc_oper=$desc_oper&vend_oper=$vend_oper&mfr_oper=$mfr_oper&rate_oper=$rate_oper\">[Last Page]</a> ";
}
else
{
