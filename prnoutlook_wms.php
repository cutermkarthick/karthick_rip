...
<html>
<head>
<title>Mfg Outlook</title>
</head>
<body leftmargin="0"topmargin="0" marginwidth="0">

<form action='prnoutlook_wms.php' method='post' enctype='multipart/form-data'>
<?php
...
<tr>
<td valign='top' bgcolor="#FFFFFF"><span class="schtext"><b>PRN:</b>&nbsp;
...
<td width="100px"  align="center" bgcolor="#EEEFEE"><span class="labeltext"><b>DN (fg)</b></td>
<td width="100px"  align="center" bgcolor="#EEEFEE"><span class="labeltext"><b>
DN-Stores (fg)</b></td>
...
printf('
		 ...
		 <td bgcolor="#FFFFFF" align="center" width="100px"><span class="schtext"><b>%d</b></td>
       ',$total,$totaldn_qty,$total_recd4stores,$total4dis,$total4grn);
		$fg = $totaldn_qty+$total4dis+$total_recd4stores;
		$grn = $total4grn;
