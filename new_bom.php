      ...
      <table style="width:1305px" border=0 cellpadding=6 cellspacing=0>
        ...
        <table border=0 bgcolor="#DFDEDF" style="width:1305px" cellspacing=1 cellpadding=3 class="stdtable1">
          ...
          <tr bgcolor="#FFFFFF" width=100%>
            ...
            <td><span class="labeltext"><p align="left">Assy Wo</p></span></td>
            <td><input type="text" name="assywonum"  id="assywonum"  size=15 value="" style="background-color:#DDDDDD;" readonly="readonly">
            <img src="images/bu-get.gif" alt="Get CIM" onclick="getassyWO4BOM()"></td>
            <input type="hidden" id="link2assywo" name="link2assywo"  size=15 value="">
            <td></td>
            <td ></td>
          </tr>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td ><input type="text" size=20 id="crn" name="crn" ></td>
            <td><span class="labeltext"><p align="left">BOM Rev #</p></span></td>
            <td ><input type="text" size=15  name="bomrevnum" id="bomrevnum"></td>
          </tr>

          <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Assy Part No.</p></span></td>
            <td ><input type="text" size=20 id="assy_part" name="assy_part" ></td>
            <td><span class="labeltext"><p align="left">DRG No</p></span></td>
            <td><input type="text" size=15 id="drg_no" name="drg_no" value="" ></td>
          </tr>

          <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">DRG Issue</p></span></td>
            <td><input type="text" size=15 id="issue" name="issue" value="" ></td>
            <td><span class="labeltext"><p align="left">COS Iss</p></span></td>
            <td><input type="text" size=25 id="cos_no" name="cos_no" value="" ></td>
          </tr>

          <tr bgcolor="#FFFFFF">
            <td><span class="labeltext"><p align="left">Title</p></span></td>
            <td><input type="text" name="title" id="title"></td>
            <td><span class="labeltext"><p align="left">Part Issue/Attachments</p></span></td>
            <td><input type="text" size=25 id="partiss" name="partiss" value="" ></td>
          </tr>
        </table>
...
<td colspan=11 align="left"><span class="heading"><b>Machining</b></td></tr>
<tr bgcolor="#FFFFFF">
...
<?php
 $z=1;
      while ($z<=3)
      {
        ...
        echo "<td><span class=\"labeltext\"><input type=\"text\" id=\"$as_crn\" name=\"$as_crn\"  size=\"10%\" value=\"\" ><img src=\"images/bu-get.gif\" alt=\"Get CIM\" onclick=\"GetCIM_sassy('$z')\" ></td>";
        echo "<td><input type=\"text\" id=\"$as_partno\" name=\"$as_partno\"  size=\"18%\" value=\"\"></td>";
        echo "<td><input type=\"text\" name=\"$as_partname\" id=\"$as_partname\" size=\"18%\" value=\"\">";
        ...
        echo "<td><input type=\"text\" id=\"$as_mpsnum\" name=\"$as_mpsnum\" size=\"9%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$as_mpsrev\" name=\"$as_mpsrev\" size=\"9%\"  value=\"\"></td>";   
		...
		echo"<input type=\"hidden\" id=\"$as_crn_type\"  size=\"8%\" name=\"$as_crn_type\" value=\"machining\" style=\"background-color:#DDDDDD;\" readonly=\"readonly\">";
...
<td colspan=11 align="left"><span class="heading"><b>Fabrication</b></td></tr>
<tr bgcolor="#FFFFFF">
...
<?php
 ...
 $i=1;
      while ($i<=3)
      {
        ...
        echo "<td width=\"5%\"><input type=\"text\" id=\"$crn\" name=\"$crn\"  size=\"10%\" value=\"\" width=\"50%\">";
        echo "<img src=\"images/bu-get.gif\" alt=\"Get CIM\" onclick=\"GetCIM('$i')\"></td>";
        echo "<td><input type=\"text\" id=\"$partno\" name=\"$partno\"  size=\"18%\" value=\"\"></td>";
        echo "<td><input type=\"text\" name=\"$partname\" id=\"$partname\"  size=\"18%\" value=\"\">";
        ...
        echo "<td><input type=\"text\" id=\"$mpsnum\" name=\"$mpsnum\" size=\"9%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$mpsrev\" name=\"$mpsrev\" size=\"9%\" value=\"\"></td>";      
        ...
        echo"<input type=\"hidden\" size=\"10%\" id=\"$crn_type\" name=\"$crn_type\" value=\"fabrication\" style=\"background-color:#DDDDDD;\" readonly=\"readonly\">";
...
<td><span class="heading"><b>Type= Non Assembly</b></td>
<td colspan=11 align="left"><span class="heading"><b>Out Sourced</b></td></tr>
<tr bgcolor="#FFFFFF">
...
<?php
 ...
 $m=1;
      while ($m<=3)
      {
        ...
        echo "<td width=\"5%\"><input type=\"text\" id=\"$tr_crn\" name=\"$tr_crn\"  size=\"10%\" value=\"\" width=\"50%\">";
        echo "<img src=\"images/bu-get.gif\" alt=\"Get CIM\" onclick=\"GetCIM_treated('$m')\"></td>";
        echo "<td><input type=\"text\" id=\"$tr_partno\" name=\"$tr_partno\"  size=\"18%\" value=\"\"></td>";
        echo "<td><input type=\"text\" name=\"$tr_partname\" id=\"$tr_partname\"  size=\"18%\" value=\"\">";
        ...
        echo "<td><input type=\"text\" id=\"$tr_mpsnum\" name=\"$tr_mpsnum\" size=\"9%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$tr_mpsrev\" name=\"$tr_mpsrev\" size=\"9%\"  value=\"\"></td>";      
        ...
        echo"<input type=\"hidden\" size=\"10%\" id=\"$tr_crn_type\" name=\"$tr_crn_type\" value=\"out sourced\" style=\"background-color:#DDDDDD;\" readonly=\"readonly\">";
...
<?php
 ...
 $j=1;
      while ($j<=3)
      {
        ...
        echo "<td width=\"5%\"><input type=\"text\" id=\"$bo_partnum\" name=\"$bo_partnum\"  size=\"12%\" value=\"\">";
        echo "<img src=\"images/bu-get.gif\" alt=\"Get Part\" onclick=\"GetPart('$j','Bought Out')\"></td>";
        echo "<td><input type=\"text\" id=\"$bo_desc\" name=\"$bo_desc\" size=\"18%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$bo_partiss\" name=\"$bo_partiss\" size=\"12%\"  value=\"\">";
        echo "<td><input type=\"text\" id=\"$bo_drgno\" name=\"$bo_drgno\" size=\"10%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$bo_issue\" name=\"$bo_issue\" size=\"10%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$bo_supp\" name=\"$bo_supp\" size=\"15%\"  value=\"\"></td>";
        echo "<td><input type=\"text\" id=\"$bo_qpa\" name=\"$bo_qpa\" size=\"5%\" value=\"\"></td>";
        echo"<input type=\"hidden\" size=\"10%\" id=\"$boi_crn_type\" name=\"$boi_crn_type\" value=\"boi\" >";
        printf('</tr>');
	   $j++;
      }
...
<?php
 $k=1;
      while ($k<=3)
      {
		...
		echo "<td width=\"5%\"><input type=\"text\" id=\"$co_partnum\" name=\"$co_partnum\"  size=\"12%\" value=\"\">";
        echo "<img src=\"images/bu-get.gif\" alt=\"Get Part\" onclick=\"GetPart('$k','Consummables')\"></td>";
        echo "<td><input type=\"text\" id=\"$co_desc\" name=\"$co_desc\" size=\"25%\"   value=\"\"></td>";     
        echo "<td><input type=\"text\" id=\"$co_issue\" name=\"$co_issue\"   size=\"8%\" value=\"\">";
        echo "<td><input type=\"text\" id=\"$co_supp\" name=\"$co_supp\" size=\"17%\"   value=\"\"></td>";
        ...
        echo"<input type=\"hidden\" size=\"10%\" id=\"$boi_crn_type\" name=\"$boi_crn_type\" value=\"consummables\" >";
