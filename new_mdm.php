...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td colspan=3><input type="text" name="project" size=20 value=""></td>
        </tr>
...
<tr>
   <td bgcolor="#FFFFFF" align=center><input type="text" name="dim1" size=10 value=""></td>
   <td bgcolor="#FFFFFF" align=center><input type="text" name="dim2" size=10 value=""></td>
   <td bgcolor="#FFFFFF" align=center><input type="text" name="dim3" size=10 value=""></td>
</tr>
