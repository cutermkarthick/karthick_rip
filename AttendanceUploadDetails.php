...
$result = $newAttendance->getUploadDetails($recnum);
...
<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3 class="stdtable">
	...
	<tr>
		...
		<td class="head0"><span class="heading"><b><center>Date</center></b></td>
		<td class="head1"><span class="heading"><b><center>Stage</center></b></td>
		<td class="head0"><span class="heading"><b><center>Lat</center></b></td>
		<td class="head1"><span class="heading"><b><center>Lon</center></b></td>
		<td class="head1"><span class="heading"><b><center>Site ID</center></b></td>
		<td class="head1"><span class="heading"><b><center>Subsidary ID</center></b></td>
	</tr>

	<?php
    $i=1;
    $result1 = $newAttendance->getUploadLIDetails($recnum);
    while ($myrowli = mysql_fetch_assoc($result1)) 
   	{	

   		if (trim($myrowli['checkInOut']) == 0) {
   			$stage = 'Out';
   		}
   		else
   		{
   		...
   		<tr bgcolor="#FFFFFF">
   			...
   			<td align="center"><span class="tabletext"><?php echo $stage; ?></span></td>
   			<td align="center"><span class="tabletext"><?php echo $myrowli['Lat']; ?></span></td>
   			<td align="center"><span class="tabletext"><?php echo $myrowli['Lon']; ?></span></td>
   			<td align="center"><span class="tabletext"><?php echo $myrowli['siteid']; ?></span></td>
   			<td align="center"><span class="tabletext"><?php echo $myrowli['subsidaryid']; ?></span></td>
   		</tr>
   	<?php
   		$i++;
    }    
