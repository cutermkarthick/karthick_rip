...
?>
<form action='stockgrn_status.php' method='post' enctype='multipart/form-data'>
...
<tr>
  ...
  <table width=100% border=0 >
   <tr><td><span class="heading"><b>Stock(GRN) Status Report - RM By Host only</b></td>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable">
        ...
        <thead>
            ...
            <th width="5%" class="head1"><span class="heading"><b>Received Date</b></th>
            <th width="7%" class="head0"><span class="heading"><b>RM Type</b></th>
            <th width="7%" class="head1"><span class="heading"><b>RM Spec</b></th>
             <th width="5%" class="head0"><span class="heading"><b>PRN</b></th>
            <th width="5%" class="head1"><span class="heading"><b>Qty To Make</b></th>
            <th width="5%" class="head0"><span class="heading"><b>Qty Issued</b></th>
            <th width="5%" class="head1"><span class="heading"><b>Qty Returned</b></th>
            <th width="5%" class="head0"><span class="heading"><b>Balance<br>(qtm+ret-woqty)</b></th>
        </tr>
