...
$_SESSION['pagename'] = 'pricesummary';
$page = "Invoice: Price";
...
<h2 class="table"><span>Price Summary
 <input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='priceEntry.php'" value="New Price"> 
 </span></h2></table>
                                ...
                                <thead>
                                     <th class="head0"><span class="tabletext"><b>Seq #</b></th>
                                      <th class="head1"><span class="tabletext"><b>Customer</b></th>
            													<th class="head0"><span class="tabletext"><b>CRN#</b></th>
            													<th class="head1"><span class="tabletext"><b>Type#</b></th>
             													<th class="head0"><span class="tabletext"><b>Partnum</b></th>
             													<th class="head1"><span class="tabletext"><b>Partname</b></th>
             													<th class="head0"><span class="tabletext"><b>Price</b></th>
            										 			<th class="head1"><span class="tabletext"><b>Valid From</b></th>
                                      <th class="head0"><span class="tabletext"><b>Valid To</b></th>
             													<th class="head1"><span class="tabletext"><b>Status</b></th>
        												</tr>
													<?php
														$result = $newprice->getprice($cond,$offset, $rowsPerPage);
	     										  		 while ($myrow = mysql_fetch_assoc($result)) {
															 ...
															 $tdate=$myrow["price_valid_to"];
                                                               if($tdate != '0000-00-00' && $tdate!= '' && $tdate != 'NULL')
                                                               {
																...
																printf('<tr><td align="center" bgcolor="#FFFFFF"><span class="tabletext"><a href="priceDetails.php?ipricerecnum=%s&custrecnum=%s"><b>%s</b></td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
                          												<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s %.2f</td>
                                     	                                <td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
																		<td align="center" bgcolor="#FFFFFF"><span class="tabletext">%s</td>
...
//Additions on Dec 29 04 by Jerry George to implement pagination
 //$numrows=10;
$numrows = $newprice->getpricecount($cond,$offset, $rowsPerPage);
...
{
    $page = $pageNum - 1;
    $prev = " <a href=\"priceSummary.php?page=$page&totpages=$totpages&final_relno=$finalrel_match&
	final_crn=$final_crnmatch&ddate1=$ddate1_match&ddate2=$ddate2_match&final_partnum=$final_partnummatch\">[Prev]</a> ";

    $first = " <a href=\"priceSummary.php?page=1&totpages=$totpages&final_relno=$finalrel_match&
...
{
    $page = $pageNum + 1;
    $next = " <a href=\"priceSummary.php?page=$page&totpages=$totpages&final_relno=$finalrel_match&
	final_crn=$final_crnmatch&ddate1=$ddate1_match&ddate2=$ddate2_match&final_partnum=$final_partnummatch\">[Next]</a> ";

    $last = " <a href=\"priceSummary.php?page=$totpages&totpages=$totpages&final_relno=$finalrel_match&
