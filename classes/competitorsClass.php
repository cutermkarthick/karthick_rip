...
//====================================
// Author: FSI
// Date-written = Aug 05, 2006
// Filename:trackcompetitorsClass.php
// Maintains the class for trackcompetitors
// Revision: v1.0  OWT
//====================================
       ...
       //echo "I am here";
        ...
        if (!(mysql_fetch_row($result))) {
           $sql = "INSERT INTO
                        competitor
                            (
                            recnum, companyname,revenue,industrysegment,
                            product,phone,email,notes, guid,
                            address1,address2,city, state,zip,country
                           )
                    VALUES
                            ( $objid,$companyname,$revenue,$industrysegment,
                            $product,$phone,$email,$notes,$guid,
                             $address1, $address2,$city,$state,$zip,$country
                            )";
...
} // End trackcompetitor class definition