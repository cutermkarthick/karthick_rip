...
// Filename: getcustomeraddress.php            =
...
<br>
        <tr>&nbsp</tr>
<?php
   $result = $newcust->getcustomers4aradrs();
?>
...
window.opener.SetShip2Customer(document.forms[0].customer[ind].text,document.forms[0].customer[ind].value);
if (ind == 0)
