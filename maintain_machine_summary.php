...
$_SESSION['pagename'] = 'maintain_machine_summary';
//////session_register('pagename');

// First include the class definition
include_once('classes/userClass.php');
include_once('classes/maintain_machineclass.php');
...
<form action='maintain_machine_summary.php' method='post' enctype='multipart/form-data'>
<?php
...
<table width=100% border=0>
  <tr>
  <td><span class="pageheading"><b>List Of Machine Master Data</b></td>
  <td colspan=160>&nbsp;</td>
  <td><a href ="maintain_machine.php"><img name="Image8" border="0" src="images/bu_newmaster.gif"></a>
  </td>
  </tr>
</table>
...
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
        <tr bgcolor="#FFCC00">
            ...
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Purpose</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Task</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Task Time</b></td>
            <td  bgcolor="#EEEFEE"><span class="tabletext"><b>Cost/hr</b></td>
        </tr>


<?php

            $result = $newMM->getmaintain_machines();

            while ($myrow = mysql_fetch_row($result)) {


   	       printf('<tr bgcolor="#FFFFFF"><td ><span class="tabletext">
                          <a href="maintain_machinedetails.php?maintain_machinerecnum=%s">%s</td>
                          <td><span class="tabletext">%s</td>
                          <td><span class="tabletext">%s</td>
                          <td><span class="tabletext">%s Mins</td>
