...
?>
 ...
 <table width="250px" style="border:1px solid #000000;" cellpadding=4 cellspacing=2 border=0 rules=all bgcolor="#FFFFFF">
 <tr bgcolor="#F5F6F5"> 
 ...
 <th class="head1"><span class="tabletext"><b>WO Qty</b></th>
 <th class="head0"><span class="tabletext"><b>WO Rej</b></th>
 <th class="head1"><span class="tabletext"><b>WO Process</b></th>
</tr>
...
{
  if ($myrow[2] == '' || $myrow[2] == 'NULL' || $myrow[2] == 'Untreated')
  {
    $woprocess = 'Untreated';
...
?>
 <tr bgcolor="#FFFFFF">  
 <td><span class="tabletext"><?echo $myrow[0];?></td>
 <td><span class="tabletext"><?echo $myrow[1];?></td>
 <td><span class="tabletext"><?echo $rej_qty;?></td>
...
<td valign="top">
 ...
 <th class="head0"><span class="tabletext"><b>Dispatch Qty</b></th>
</tr>
...
?>
 ...
 <td><span class="tabletext"><?echo $myrow[2];?></td>
 <td><span class="tabletext"><?echo $qty ;?></td>
...
<td valign="top">
 ...
 <tr>
 <th class="head0"><span class="tabletext"><b>WO #</b></th>
  <th class="head1"><span class="tabletext"><b>Assy WO #</b></th>
  <th class="head0"><span class="tabletext"><b>PRN #</b></th>
 <th class="head1"><span class="tabletext"><b>WO Qty</b></th>
 <th class="head0"><span class="tabletext"><b>Qty Used<br>for Assy WO</b></th>
</tr>
...
?>
 <tr bgcolor="#FFFFFF">
 <td><span class="tabletext"><?echo $myrow[0];?></td>
 <td><span class="tabletext"><?echo $myrow[6];?></td>
  <td><span class="tabletext"><?echo $myrow[7];?></td>
 <td><span class="tabletext"><?echo $qty;?></td>
 <td><span class="tabletext"><?echo $myrow[5];?></td>
 </tr>
<?
}
?>
...
while($myrow4disp = mysql_fetch_row($result1))
{
   ...
   //echo "<br>myrow4disp is $myrow4disp[0]";
    if($myrow4disp[5] == 0)
    {
...
<?
 ...
 <tr>
 <th  class="head0"><span class="tabletext"><b>GRN #</b></td>
 <th  class="head1"><span class="tabletext"><b>Qty Make</b></td>
 <th  class="head0"><span class="tabletext"><b>Available <br>Qty</b></td>
 </tr>
 <?
 ...
 <th class="head0"><span class="tabletext"><b>Qty Make</b></th>
  ...
  while($myrow4grn_quar = mysql_fetch_row($result_grn_quar))
  {
   ...
   if($myrow4grn_quar[2] !=0)
    ...
    ?>
     ...
     <td><span class="tabletext"><?echo $myrow4CRN_quar[0];?></td>
     <td><span class="tabletext"><?echo $myrow4grn_quar[1];?></td>
     <td><span class="tabletext"><?echo $myrow4grn_quar[2];?></td>
     </tr>
  <?
   }
  }
