 ...
 <table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=3>
  ...
  <td  bgcolor="#DFDEDE" colspan=2><span class="labeltext"><p align="left">
   ...
   <tr bgcolor="#EEEFEE" width=100%>
                   <td bgcolor="#EEEFEE" ><span class="labeltext"><p align="left">10.00</p></font></td>
               <td><input type="text" name="task1" size=60 value="">
                   </td>
                   <input type="hidden" name="taskdate" value="<?php //echo $tdate["mday"] . " ". $tdate["month"]. " , ". $tdate["year"]
                                                                       echo $tdate["year"] . "-". trim($m). "-". $tdate["mday"]?>"></td>
          </tr>

   		  <tr bgcolor="#EEEFEE" width=100%>
                   <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">11.00</p></font></td>
            	      <td><input type="text" name="task2" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		  <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">12.00</p></font></td>
            	      <td><input type="text" name="task3" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		  <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">13.00</p></font></td>
            	      <td><input type="text" name="task4" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		  <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">14.00</p></font></td>
            	      <td><input type="text" name="task5" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		  <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">15.00</p></font></td>
            	      <td><input type="text" name="task6" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		  <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">16.00</p></font></td>
            	      <td><input type="text" name="task7" size=60 value="">
                   </td>
           </tr>
 			   <tr bgcolor="#EEEFEE">
           		   <td bgcolor="#EEEFEE"><span class="labeltext"><p align="left">17.00</p></font></td>
            	      <td><input type="text" name="task8" size=60 value="">
                   </td>
           </tr>
   </table>
</table>
